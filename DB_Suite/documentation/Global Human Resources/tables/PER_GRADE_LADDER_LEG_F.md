...
PER_GRADE_LADDER_LEG_F stores the legislative attributes for a Grade Ladder.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradeladderlegf-15649.html](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradeladderlegf-15649.html)

## Primary Key

| Name | Columns |
|------|----------|
| PER_GRADE_LADDER_LEG_F_PK | GRADE_LADDER_LEG_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| GRADE_LADDER_LEG_ID | NUMBER |  | 18 | Yes | System generated primary key column. |
...
| GRADE_LADDER_ID | NUMBER |  | 18 | Yes | Foreign Key to PER_GRADE_LADDERS_F table. |
...
|-------|------------|------------|----------|
| PER_GRADE_LADDER_LEG_F_N1 | Non Unique | APPS_TS_TX_DATA | GRADE_LADDER_ID |
| PER_GRADE_LADDER_LEG_F_N11 | Non Unique | Default | UPPER("INFORMATION1") |
| PER_GRADE_LADDER_LEG_F_N12 | Non Unique | Default | UPPER("INFORMATION2") |
| PER_GRADE_LADDER_LEG_F_N13 | Non Unique | Default | UPPER("INFORMATION3") |
| PER_GRADE_LADDER_LEG_F_N14 | Non Unique | Default | UPPER("INFORMATION4") |
| PER_GRADE_LADDER_LEG_F_N15 | Non Unique | Default | UPPER("INFORMATION5") |
| PER_GRADE_LADDER_LEG_F_N16 | Non Unique | Default | INFORMATION6 |
| PER_GRADE_LADDER_LEG_F_N17 | Non Unique | Default | INFORMATION7 |
| PER_GRADE_LADDER_LEG_F_N18 | Non Unique | Default | INFORMATION8 |
| PER_GRADE_LADDER_LEG_F_N19 | Non Unique | Default | INFORMATION9 |
| PER_GRADE_LADDER_LEG_F_N20 | Non Unique | Default | INFORMATION10 |
| PER_GRADE_LADDER_LEG_F_N31 | Non Unique | Default | INFORMATION_NUMBER1 |
| PER_GRADE_LADDER_LEG_F_N32 | Non Unique | Default | INFORMATION_NUMBER2 |
| PER_GRADE_LADDER_LEG_F_N33 | Non Unique | Default | INFORMATION_NUMBER3 |
| PER_GRADE_LADDER_LEG_F_N34 | Non Unique | Default | INFORMATION_NUMBER4 |
| PER_GRADE_LADDER_LEG_F_N35 | Non Unique | Default | INFORMATION_NUMBER5 |
| PER_GRADE_LADDER_LEG_F_N41 | Non Unique | Default | INFORMATION_DATE1 |
| PER_GRADE_LADDER_LEG_F_N42 | Non Unique | Default | INFORMATION_DATE2 |
| PER_GRADE_LADDER_LEG_F_N43 | Non Unique | Default | INFORMATION_DATE3 |
| PER_GRADE_LADDER_LEG_F_N44 | Non Unique | Default | INFORMATION_DATE4 |
| PER_GRADE_LADDER_LEG_F_N45 | Non Unique | Default | INFORMATION_DATE5 |
| PER_GRADE_LADDER_LEG_F_PK | Unique | Default | GRADE_LADDER_LEG_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
