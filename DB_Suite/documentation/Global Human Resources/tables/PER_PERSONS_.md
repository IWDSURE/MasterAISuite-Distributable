...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersons-14780.html](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersons-14780.html)

## Primary Key

| Name | Columns |
|------|----------|
| PER_PERSONS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_ID |
...
| START_DATE | DATE |  |  |  | Start date of person record on system, always equal to earliest effective_start_date on per_all_people_f. |
...
|-------|------------|------------|----------|
| PER_PERSONS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_ID |
| PPERN1_ | Non Unique | Default | PERSON_ID, LAST_UPDATE_DATE |
