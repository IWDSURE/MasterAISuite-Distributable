...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionextrainfof-29353.html](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionextrainfof-29353.html)
...
|-------|------------|------------|----------|
| PER_POSITION_EXTRA_INFO_FK1 | Non Unique | FUSION_TS_TX_DATA | INFORMATION_TYPE |
| PER_POSITION_EXTRA_INFO_F_PK | Unique | FUSION_TS_TX_DATA | POSITION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_POSITION_EXTRA_INFO_N3 | Non Unique | FUSION_TS_TX_DATA | POSITION_ID, INFORMATION_TYPE |
