...
PER_GRADE_EXTRA_INFO_F holds extra information for the Grades. Introduced in Grades as part of Key Flex Field removal in Fusion.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradeextrainfof-24986.html](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradeextrainfof-24986.html)

## Primary Key

| Name | Columns |
|------|----------|
| PER_GRADE_EXTRA_INFO_F_PK | GRADE_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| GRADE_EXTRA_INFO_ID | NUMBER |  | 18 | Yes | System generated primary key column. |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| BUSINESS_GROUP_ID | NUMBER |  | 18 | Yes | Identifier of Enterprise, used for multi-tenancy partitioning. Foreign key to HR_ORGANIZATION_UNITS. |
| INFORMATION_TYPE | VARCHAR2 | 40 |  | Yes | Type of information. |
...
|-------|------------|------------|----------|
| PER_GRADE_EXTRA_INFO_F_N1 | Non Unique | Default | INFORMATION_TYPE |
| PER_GRADE_EXTRA_INFO_F_N11 | Non Unique | Default | UPPER("INFORMATION1") |
| PER_GRADE_EXTRA_INFO_F_N12 | Non Unique | Default | UPPER("INFORMATION2") |
| PER_GRADE_EXTRA_INFO_F_N13 | Non Unique | Default | UPPER("INFORMATION3") |
| PER_GRADE_EXTRA_INFO_F_N14 | Non Unique | Default | UPPER("INFORMATION4") |
| PER_GRADE_EXTRA_INFO_F_N15 | Non Unique | Default | UPPER("INFORMATION5") |
| PER_GRADE_EXTRA_INFO_F_N16 | Non Unique | Default | INFORMATION6 |
| PER_GRADE_EXTRA_INFO_F_N17 | Non Unique | Default | INFORMATION7 |
| PER_GRADE_EXTRA_INFO_F_N18 | Non Unique | Default | INFORMATION8 |
| PER_GRADE_EXTRA_INFO_F_N19 | Non Unique | Default | INFORMATION9 |
| PER_GRADE_EXTRA_INFO_F_N2 | Non Unique | Default | GRADE_ID |
| PER_GRADE_EXTRA_INFO_F_N20 | Non Unique | Default | INFORMATION10 |
| PER_GRADE_EXTRA_INFO_F_N31 | Non Unique | Default | INFORMATION_NUMBER1 |
| PER_GRADE_EXTRA_INFO_F_N32 | Non Unique | Default | INFORMATION_NUMBER2 |
| PER_GRADE_EXTRA_INFO_F_N33 | Non Unique | Default | INFORMATION_NUMBER3 |
| PER_GRADE_EXTRA_INFO_F_N34 | Non Unique | Default | INFORMATION_NUMBER4 |
| PER_GRADE_EXTRA_INFO_F_N35 | Non Unique | Default | INFORMATION_NUMBER5 |
| PER_GRADE_EXTRA_INFO_F_N41 | Non Unique | Default | INFORMATION_DATE1 |
| PER_GRADE_EXTRA_INFO_F_N42 | Non Unique | Default | INFORMATION_DATE2 |
| PER_GRADE_EXTRA_INFO_F_N43 | Non Unique | Default | INFORMATION_DATE3 |
| PER_GRADE_EXTRA_INFO_F_N44 | Non Unique | Default | INFORMATION_DATE4 |
| PER_GRADE_EXTRA_INFO_F_N45 | Non Unique | Default | INFORMATION_DATE5 |
| PER_GRADE_EXTRA_INFO_F_PK | Unique | Default | GRADE_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
