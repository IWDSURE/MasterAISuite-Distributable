...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peremailaddresses-27394.html](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peremailaddresses-27394.html)

## Primary Key

| Name | Columns |
|------|----------|
| PER_EMAIL_ADDRESSES_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, EMAIL_ADDRESS_ID |
...
| PERSON_ID | NUMBER |  | 18 |  | Person for whom this e-mail address is recorded. |
| BUSINESS_GROUP_ID | NUMBER |  | 18 |  | Identifier of Enterprise, used for multi-tenancy partitioning. Foreign key to HR_ORGANIZATION_UNITS. |
| EMAIL_TYPE | VARCHAR2 | 30 |  |  | Type of email (e.g. work, personal) |
...
|-------|------------|------------|----------|
| PEAN1_ | Non Unique | Default | EMAIL_ADDRESS_ID, LAST_UPDATE_DATE |
| PER_EMAIL_ADDRESSES_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, EMAIL_ADDRESS_ID |
