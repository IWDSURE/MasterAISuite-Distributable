...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtspecialprojectitemsv-31494.html#hrtspecialprojectitemsv-31494](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtspecialprojectitemsv-31494.html#hrtspecialprojectitemsv-31494)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_SPL_PROJECT_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PROJECT_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PROJECT_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| EMPLOYER | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| BUSINESS_UNIT | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| ROLE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MANAGER | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| CATEGORY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| CUSTOMER_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| PROJECT_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| URL | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| BILLABLE_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| START_DATE | DATE |  |  |  | A generic date field |
| END_DATE | DATE |  |  |  | A generic date field |
| CONTACT_PERSON_ID | NUMBER |  | 18 |  | A generic number field |
...
|---|---|---|---|
| HRT_SPL_PROJECT_ITEMS_VN1_ | Non Unique | Default | PROJECT_ID, LAST_UPDATE_DATE |
| HRT_SPL_PROJECT_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PROJECT_ID |
