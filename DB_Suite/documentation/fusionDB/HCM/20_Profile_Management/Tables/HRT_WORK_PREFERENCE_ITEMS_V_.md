...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtworkpreferenceitemsv-4290.html#hrtworkpreferenceitemsv-4290](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtworkpreferenceitemsv-4290.html#hrtworkpreferenceitemsv-4290)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_WORK_PREF_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORK_PREF_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| WORK_PREF_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| RELOCATION_REASON | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| NAT_TRAVEL_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| NAT_TRAVEL_REQUIRED_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| NAT_TRAVEL_FREQUENCY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| REQUIRED_NAT_TRAVEL_FREQ | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| INTL_TRAVEL_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| INTL_TRAVEL_REQUIRED_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| INTL_TRAVEL_FREQUENCY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| REQUIRED_INTL_TRAVEL_FREQ | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| RELOCATE_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| ALL_LOCATIONS_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| TEMP_ASSIGN_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| PART_ASSIGN_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| FLEXIBLE_WORK_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| CURRENCY_CODE | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| PAY_FREQUENCY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| PAY_RANGE | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| WORK_DAYS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| WORK_HOURS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| PREFERRED_LOCATION_ID1 | NUMBER |  | 18 |  | A generic number field |
| WORK_MONTHS | NUMBER |  | 18 |  | A generic number field |
| PREFERRED_LOCATION_ID2 | NUMBER |  | 18 |  | A generic number field |
| WORK_YEARS | NUMBER |  | 18 |  | A generic number field |
| PREFERRED_LOCATION_ID3 | NUMBER |  | 18 |  | A generic number field |
| PREFERRED_LOCATION_ID4 | NUMBER |  | 18 |  | A generic number field |
| EXCLUDED_LOCATION_ID1 | NUMBER |  | 18 |  | A generic number field |
| EXCLUDED_LOCATION_ID2 | NUMBER |  | 18 |  | A generic number field |
| EXCLUDED_LOCATION_ID3 | NUMBER |  | 18 |  | A generic number field |
| EXCLUDED_LOCATION_ID4 | NUMBER |  | 18 |  | A generic number field |
| MINIMUM_PAY | NUMBER |  | 18 |  | A generic number field |
| RELOCATE_DURATION | NUMBER |  | 18 |  | A generic number field |
| FULL_TIME_EQUIVALENT | NUMBER |  | 15 |  | A generic decimal field |
...
|---|---|---|---|
| HRT_WORK_PREF_ITEMS_VN1_ | Non Unique | Default | WORK_PREF_ID, LAST_UPDATE_DATE |
| HRT_WORK_PREF_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORK_PREF_ID |
