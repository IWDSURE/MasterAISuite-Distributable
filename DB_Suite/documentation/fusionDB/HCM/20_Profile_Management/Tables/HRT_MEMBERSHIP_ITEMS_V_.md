...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtmembershipitemsv-18118.html#hrtmembershipitemsv-18118](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtmembershipitemsv-18118.html#hrtmembershipitemsv-18118)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_MEMBERSHIP_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, MEMBERSHIP_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| MEMBERSHIP_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| REQUIRED_FLAG | VARCHAR2 | 30 |  |  | A generic mandatory check box |
...
| AFFILIATION_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MANDATE_POSITION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| AWARDING_BODY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MONTHLY_TIME_COMMITMENT | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| VOLUNTEER_CAUSE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| PROFESSIONAL_BODY_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MEMBERSHIP_NUMBER | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MEMBERSHIP_CATEGORY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| EDUCATIONAL_ESTABLISHMENT | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| ORGANIZATION_URL | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| CURRENT_MEMBERSHIP_REQ_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| CURRENT_VOLUNTEER_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| FEE_CURRENCY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| SUBSCRIPTION_PAY_METH | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| INTERNAL_ORG_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| STATUS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| MEMBERSHIP_START_DATE | DATE |  |  |  | A generic date field |
| MEMBERSHIP_END_DATE | DATE |  |  |  | A generic date field |
| POSITION_START_DATE | DATE |  |  |  | A generic date field |
| MEMBERSHIP_DATE | DATE |  |  |  | A generic date field |
| POSITION_END_DATE | DATE |  |  |  | A generic date field |
...
|---|---|---|---|
| HRT_MEMBERSHIP_ITEMS_VN1_ | Non Unique | Default | MEMBERSHIP_ID, LAST_UPDATE_DATE |
| HRT_MEMBERSHIP_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, MEMBERSHIP_ID |
