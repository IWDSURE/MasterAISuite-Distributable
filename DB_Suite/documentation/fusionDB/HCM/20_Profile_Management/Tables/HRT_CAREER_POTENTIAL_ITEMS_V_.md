...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcareerpotentialitemsv-16729.html#hrtcareerpotentialitemsv-16729](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcareerpotentialitemsv-16729.html#hrtcareerpotentialitemsv-16729)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_CAREER_POT_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, CAREER_POTENTIAL_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| CAREER_POTENTIAL_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| POTENTIAL_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| POTENTIAL_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| POTENTIAL_SCORE | NUMBER |  | 15 |  | A generic decimal field |
| POTENTIAL_COMMENTS | CLOB |  |  |  | A generic CLOB field |
...
|---|---|---|---|
| HRT_CAR_POT_ITEMS_V_N1_ | Non Unique | Default | CAREER_POTENTIAL_ID, LAST_UPDATE_DATE |
| HRT_CAREER_POT_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, CAREER_POTENTIAL_ID |
