...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcontentitemstl-25696.html#hrtcontentitemstl-25696](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcontentitemstl-25696.html#hrtcontentitemstl-25696)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_CONTENT_ITEMS_TL_PK | CONTENT_ITEM_ID, BUSINESS_GROUP_ID, LANGUAGE |
...
| ITEM_CLOB_TL_1 | CLOB |  |  |  | Text column in defining Content Type properties |  |
| ITEM_CLOB_TL_2 | CLOB |  |  |  | Text column in defining Content Type properties |  |
...
|---|---|---|---|
| HRT_CONTENT_ITEMS_TL_N1 | Non Unique | Default | LANGUAGE, UPPER("NAME") |
| HRT_CONTENT_ITEMS_TL_PK | Unique | Default | CONTENT_ITEM_ID, BUSINESS_GROUP_ID, LANGUAGE, ORA_SEED_SET1 |
| HRT_CONTENT_ITEMS_TL_PK1 | Unique | Default | CONTENT_ITEM_ID, BUSINESS_GROUP_ID, LANGUAGE, ORA_SEED_SET2 |
