...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtnotes-3866.html#hrtnotes-3866](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtnotes-3866.html#hrtnotes-3866)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_NOTES_PK | NOTE_ID, ENTERPRISE_ID |
...
|---|---|---|---|
| HRT_NOTES_N1 | Non Unique | Default | OBJECT_TYPE, OBJECT_ID, AUTHOR_ID, NOTE_VISIBILITY_CODE, HIDDEN_FLAG |
| HRT_NOTES_N2 | Non Unique | Default | AUTHOR_ID |
| HRT_NOTES_U1 | Unique | Default | NOTE_ID, ENTERPRISE_ID |
