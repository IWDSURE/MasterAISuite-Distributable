# HRT_ESTABLISHMENTS_B_BK

Backup table for HRT_ESTABLISHMENTS_B.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtestablishmentsbbk-7549.html#hrtestablishmentsbbk-7549](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtestablishmentsbbk-7549.html#hrtestablishmentsbbk-7549)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_ESTABLISHMENTS_B_BK_PK | INSTANCE_ID, ESTABLISHMENT_ID |
...
|---|---|---|---|
| HRT_ESTABLISHMENTS_B_BK_PK | Unique | Default | INSTANCE_ID, ESTABLISHMENT_ID |
