...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrteducationitemsv-22189.html#hrteducationitemsv-22189](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrteducationitemsv-22189.html#hrteducationitemsv-22189)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_EDUCATION_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, EDUCATION_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| EDUCATION_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| MAJOR | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| AREA_OF_STUDY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| AWARDING_BODY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| EDUCATOR | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| MINOR | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| AVG_GRADE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| COMP_TRAINING_UNITS | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| DURATION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| DEPARTMENT | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| TITLE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| DEGREE_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| CITY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| EDUCATIONAL_ESTABLISHMENT | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| EDUCATION_URL | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| GRADUATED_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| GRADUATION_REQUIRED_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| TRMNL_DEG_DISCP_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| FEE_CURRENCY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| ACADEMIC_STANDING | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| PART_TIME_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| DURATION_UNITS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| TUITION_METHOD | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| EDUCATION_LEVEL | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| STATUS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| EDU_LEVEL_COMP_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| HIGHEST_EDU_LEVEL | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| END_DATE | DATE |  |  |  | A generic date field |
| DATE_ACQUIRED | DATE |  |  |  | A generic date field |
| START_DATE | DATE |  |  |  | A generic date field |
| PROJECTED_COMP_DATE | DATE |  |  |  | A generic date field |
| FEE | NUMBER |  | 18 |  | A generic number field |
| COMPLETED_AMOUNT | NUMBER |  |  |  | A generic number field |
| TOTAL_AMOUNT | NUMBER |  |  |  | A generic number field |
| YEAR_ACQUIRED | NUMBER |  | 18 |  | A generic number field |
| EDUCATIONAL_ESTABLISHMENT_ID | NUMBER |  | 18 |  | A generic number field |
| GPA | NUMBER |  | 15 |  | A generic decimal field |
| REQUIRED_GPA | NUMBER |  | 15 |  | A generic decimal field |
| COMMENTS | CLOB |  |  |  | A generic CLOB field |
| DESCRIPTION | CLOB |  |  |  | A generic CLOB field |
| ACTIVITY_SUMMARY | CLOB |  |  |  | A generic CLOB field |
| REIMBURSEMENTS | CLOB |  |  |  | A generic CLOB field |
...
|---|---|---|---|
| HRT_EDU_ITEMS_V_N1_ | Non Unique | Default | EDUCATION_ID, LAST_UPDATE_DATE |
| HRT_EDUCATION_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, EDUCATION_ID |
