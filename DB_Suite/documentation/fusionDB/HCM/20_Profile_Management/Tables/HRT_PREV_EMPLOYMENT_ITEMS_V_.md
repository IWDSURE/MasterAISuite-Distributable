...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprevemploymentitemsv-13663.html#hrtprevemploymentitemsv-13663](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprevemploymentitemsv-13663.html#hrtprevemploymentitemsv-13663)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_PREV_EMPLOY_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PREV_EMPLOYMENT_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PREV_EMPLOYMENT_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| EMPLOYER_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| JOB_TITLE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| START_DATE | DATE |  |  |  | A generic date field |
| END_DATE | DATE |  |  |  | A generic date field |
| RESPONSIBILITIES | CLOB |  |  |  | A generic CLOB field |
| EMPLOYER_COUNTRY_ID | NUMBER |  | 18 |  | Country Id referencing HZ_GEOGRAPHIES |
| COUNTRY_CODE | VARCHAR2 | 30 |  |  | CountryCode is based upon tables FND_TERRITORIES_VL |
| EMPLOYER_STATE_ID | NUMBER |  | 18 |  | State Id referencing HZ_GEOGRAPHIES |
| STATE_PROVINCE_CODE | VARCHAR2 | 360 |  |  | StateProvinceCode is based upon tables HZ_GEOGRAPHY_IDENTIFIERS and  HZ_GEOGRAPHIES |
| EMPLOYER_CITY | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| CURRENT_JOB_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| FULL_TIME_CODE | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| INTERNAL_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| BUSINESS_TYPE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| EMPLOYER_PHONE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| DEPARTMENT | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| JOB_FAMILY_ID | NUMBER |  | 18 |  | A generic number field |
| JOB_FUNCTION | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| OTHER_JOB_FUNCTION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| ACHIEVEMENTS | CLOB |  |  |  | A generic CLOB field |
| DIRECT_REPORTS | NUMBER |  | 18 |  | A generic number field |
| STARTING_POSITION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| SUPERVISOR_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| SUPERVISOR_TITLE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| SUPERVISOR_EMAIL | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| SUPERVISOR_PHONE | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| CONTACT_SUPERVISOR_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| LEAVING_REASON | CLOB |  |  |  | A generic CLOB field |
| ADDITIONAL_INFO | CLOB |  |  |  | A generic CLOB field |
| START_COMPENSATION | NUMBER |  | 15 |  | A generic decimal field |
| END_COMPENSATION | NUMBER |  | 15 |  | A generic decimal field |
| OTHER_COMPENSATION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| COMPANY_URL | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
...
|---|---|---|---|
| HRT_PREV_EMPLOY_ITEMS_VN1_ | Non Unique | Default | PREV_EMPLOYMENT_ID, LAST_UPDATE_DATE |
| HRT_PREV_EMPLOY_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PREV_EMPLOYMENT_ID |
