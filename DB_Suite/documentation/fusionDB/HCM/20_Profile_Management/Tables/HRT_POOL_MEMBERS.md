...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtpoolmembers-25928.html#hrtpoolmembers-25928](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtpoolmembers-25928.html#hrtpoolmembers-25928)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_POOL_MEMBERS_PK | ENTERPRISE_ID, POOL_MEMBER_ID |
...
| POOL_MEMBER_TYPE | VARCHAR2 | 120 |  | Yes | Pool Member Type |
| MEMBER_ID | NUMBER |  | 18 | Yes | ID of the member - it can be person id or some other id. |
| STATUS | VARCHAR2 | 120 |  | Yes | Status - Active or Inactive |
...
|---|---|---|---|
| HRT_POOL_MEMBERS_N1 | Non Unique | FUSION_TS_TX_DATA | MEMBER_ID, ENTERPRISE_ID |
| HRT_POOL_MEMBERS_PK | Unique | Default | ENTERPRISE_ID, POOL_MEMBER_ID |
| HRT_POOL_MEMBERS_U1 | Unique | FUSION_TS_TX_DATA | POOL_ID, ENTERPRISE_ID, POOL_MEMBER_TYPE, MEMBER_ID |
