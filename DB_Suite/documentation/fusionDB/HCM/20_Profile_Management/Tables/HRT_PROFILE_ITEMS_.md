...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofileitems-15876.html#hrtprofileitems-15876](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofileitems-15876.html#hrtprofileitems-15876)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_PROFILE_ITEMS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PROFILE_ITEM_ID |
...
|---|---|---|---|
| HRT_PROFILE_ITEMSN1_ | Non Unique | Default | PROFILE_ITEM_ID, LAST_UPDATE_DATE |
| HRT_PROFILE_ITEMS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PROFILE_ITEM_ID |
