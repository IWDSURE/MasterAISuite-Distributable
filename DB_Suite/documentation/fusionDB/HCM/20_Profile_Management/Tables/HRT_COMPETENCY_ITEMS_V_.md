...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcompetencyitemsv-30923.html#hrtcompetencyitemsv-30923](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtcompetencyitemsv-30923.html#hrtcompetencyitemsv-30923)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_COMPETENCY_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, COMPETENCY_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| COMPETENCY_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| EVALUATION_TYPE | NUMBER |  | 18 |  | The instance qualifier to use for the item |
| REVIEWER_NAME | NUMBER |  | 18 |  | The instance qualifier to use for the item |
| REVIEWER | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| PROF_RATING_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| MIN_PROF_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| MAX_PROF_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| PERF_RATING_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| MIN_PROF_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| PROF_RATING_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| MAX_PROF_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
...
| COMPETENCY_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| REVIEWER_APPR_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| REVIEW_ACTIVE_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| REVIEW_START_DATE | DATE |  |  |  | A generic date field |
| REVIEW_END_DATE | DATE |  |  |  | A generic date field |
| REVIEW_DATE | DATE |  |  |  | A generic date field |
| WEIGHT | NUMBER |  | 18 |  | A generic number field |
| YEAR_LAST_USED | NUMBER |  | 18 |  | A generic number field |
| YEAR_ACQUIRED | NUMBER |  | 18 |  | A generic number field |
| MIN_WEIGHT | NUMBER |  | 18 |  | A generic number field |
| ASSESSMENT_YEAR | NUMBER |  | 18 |  | A generic number field |
| YEARS_OF_EXP | NUMBER |  | 15 |  | A generic decimal field |
| COMMENTS | CLOB |  |  |  | A generic CLOB field |
| EVAL_COMMENTS | CLOB |  |  |  | A generic CLOB field |
...
|---|---|---|---|
| HRT_COM_ITEMS_V_N1_ | Non Unique | Default | COMPETENCY_ID, LAST_UPDATE_DATE |
| HRT_COMPETENCY_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, COMPETENCY_ID |
