...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtlanguageitemsv-16456.html#hrtlanguageitemsv-16456](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtlanguageitemsv-16456.html#hrtlanguageitemsv-16456)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_LANGUAGE_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, LANGUAGE_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| LANGUAGE_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| LANGUAGE_NAME | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| WRITING_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| SPEAKING_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| READING_LEVEL_ID | NUMBER |  | 18 |  | The rating value. The values depend on the rating model selected. |
| NATIVE_SPEAKER_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| ABLE_TO_TRANSLATE_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| ABLE_TO_TEACH_FLAG | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| EVALUATED_ON | DATE |  |  |  | A generic date field |
| EVALUATION_LOCATION | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| COMMENTS | CLOB |  |  |  | A generic CLOB field |
| READING_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| WRITING_MODEL_ID | NUMBER |  | 18 |  | The rating model |
| SPEAKING_MODEL_ID | NUMBER |  | 18 |  | The rating model |
...
|---|---|---|---|
| HRT_LANGUAGE_ITEMS_VN1_ | Non Unique | Default | LANGUAGE_ID, LAST_UPDATE_DATE |
| HRT_LANGUAGE_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, LANGUAGE_ID |
