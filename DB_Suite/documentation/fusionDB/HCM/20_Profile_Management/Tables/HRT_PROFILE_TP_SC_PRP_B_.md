...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletpscprpb-23890.html#hrtprofiletpscprpb-23890](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletpscprpb-23890.html#hrtprofiletpscprpb-23890)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_PROFILE_TP_SEC_PROPS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SECTION_PROP_ID, BUSINESS_GROUP_ID |
...
|---|---|---|---|
| HRT_PROFILE_TP_SC_PRP_BN1_ | Non Unique | Default | SECTION_PROP_ID, BUSINESS_GROUP_ID, LAST_UPDATE_DATE |
| HRT_PROFILE_TP_SC_PRP_B_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SECTION_PROP_ID, BUSINESS_GROUP_ID |
