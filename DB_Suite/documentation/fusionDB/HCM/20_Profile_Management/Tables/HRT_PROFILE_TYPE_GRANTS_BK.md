# HRT_PROFILE_TYPE_GRANTS_BK

Backup table for HRT_PROFILE_TYPE_GRANTS
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletypegrantsbk-30160.html#hrtprofiletypegrantsbk-30160](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletypegrantsbk-30160.html#hrtprofiletypegrantsbk-30160)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_PROFILE_TYPE_GRANTS_BK_PK | INSTANCE_ID, PROFILE_TYPE_GRANT_ID |
...
|---|---|---|---|
| HRT_PROFILE_TYPE_GRANTS_BK_U1 | Unique | Default | INSTANCE_ID, PROFILE_TYPE_GRANT_ID |
