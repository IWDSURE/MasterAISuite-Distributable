...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtskillsitemsv-13647.html#hrtskillsitemsv-13647](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtskillsitemsv-13647.html#hrtskillsitemsv-13647)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_SKILLS_ITEMS_V_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SKILL_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| SKILL_ID | NUMBER |  | 18 | Yes | System generated primary key |
...
| SKILLS | VARCHAR2 | 240 |  |  | A comments field of up to 240 characters |
| PROJECT_NAME | VARCHAR2 | 2000 |  |  | A comments field of up to 2000 characters |
| SPECIALITY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| DATE_ACHIEVED | DATE |  |  |  | A generic date field |
| YEARS_OF_EXPERIENCE | NUMBER |  | 18 |  | A generic number field |
| MIN_YEARS_EXPERIENCE | NUMBER |  | 18 |  | A generic number field |
| COMMENTS | CLOB |  |  |  | A generic CLOB field |
| DESCRIPTION | CLOB |  |  |  | A generic CLOB field |
| SKILL_LEVEL_ID | NUMBER |  | 18 |  | A generic number field |
| MIN_SKILL_LEVEL_ID | NUMBER |  | 18 |  | A generic number field |
| MAX_SKILL_LEVEL_ID | NUMBER |  | 18 |  | A generic number field |
| SKILL_RATING_MODEL_ID | NUMBER |  | 18 |  | A generic number field |
| MIN_SKILL_RATING_MODEL_ID | NUMBER |  | 18 |  | A generic number field |
| MAX_SKILL_RATING_MODEL_ID | NUMBER |  | 18 |  | A generic number field |
| SKILL_CATEGORY | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| SKILL_RECOMMENDATION_TYPE | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| SKILL_GROUP | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| CONFIRMATION_STATUS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| CONFIRMATION_DATE | DATE |  |  |  | A generic date field |
| SKILL_CURATION_TYPE | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
| SKILL_CURATION_STATUS | VARCHAR2 | 30 |  |  | A comments field of up to 30 characters |
...
|---|---|---|---|
| HRT_SKILLS_ITEMS_V_N1_ | Non Unique | Default | SKILL_ID, LAST_UPDATE_DATE |
| HRT_SKILLS_ITEMS_V_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SKILL_ID |
