# HRT_PROFILE_TYP_SECTIONS_BK

Backup table for HRT_PROFILE_TYP_SECTIONS
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletypsectionsbk-25377.html#hrtprofiletypsectionsbk-25377](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrtprofiletypsectionsbk-25377.html#hrtprofiletypsectionsbk-25377)

## Primary Key

| Name | Columns |
|------|----------|
| HRT_PROFILE_TYP_SECTIONS_BK_PK | INSTANCE_ID, SECTION_ID, BUSINESS_GROUP_ID |
...
|---|---|---|---|
| HRT_PROFILE_TYP_SECTIONS_BK_U1 | Unique | Default | INSTANCE_ID, SECTION_ID, BUSINESS_GROUP_ID, ORA_SEED_SET1 |
| HRT_PROFILE_TYP_SECTION_BK_U11 | Unique | Default | INSTANCE_ID, SECTION_ID, BUSINESS_GROUP_ID, ORA_SEED_SET2 |
