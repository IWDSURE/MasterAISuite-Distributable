...
This table stores all items applicable to a template section. For example, an FY07 appraisal template contains a Competency section which has Java Skills and Communication Skills as competency items.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hratmplsecitems-27712.html#hratmplsecitems-27712](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hratmplsecitems-27712.html#hratmplsecitems-27712)

## Primary Key

| Name | Columns |
|------|----------|
| HRA_TMPL_SEC_ITEMS_PK | ITEM_ID, BUSINESS_GROUP_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments | Status |
|---|---|---|---|---|---|---|
| ITEM_ID | NUMBER |  | 18 | Yes | Primary key of the Template Section Items. |  |
...
| NAME | VARCHAR2 | 240 |  |  | Template Section Item name. |  |
| DESCRIPTION | VARCHAR2 | 4000 |  |  | This is the description of the content item, from the content library. |  |
| MEASUREMENT | VARCHAR2 | 4000 |  |  | This is the measurement criterion for the item |  |
...
|---|---|---|---|
| HRA_TMPL_SEC_ITEMS_PK | Unique | Default | ITEM_ID, BUSINESS_GROUP_ID |
| HRA_TMPL_SEC_ITEMS_UK1 | Unique | Default | SECTION_ID, CONTENT_ITEM_ID, BUSINESS_GROUP_ID |
