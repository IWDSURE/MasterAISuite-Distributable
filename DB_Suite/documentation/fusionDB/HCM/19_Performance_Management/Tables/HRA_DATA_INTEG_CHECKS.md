...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hradataintegchecks-31044.html#hradataintegchecks-31044](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hradataintegchecks-31044.html#hradataintegchecks-31044)

## Primary Key

| Name | Columns |
|------|----------|
| HRA_DATA_INTEG_CHECKS_PK | DATA_INTEG_CHECK_ID |
...
| TEMPLATE_NAME | VARCHAR2 | 240 |  |  | Performance Template Name as defined in hra_tmpl_defns_tl. |
| TMPL_PERIOD_ID | NUMBER |  | 18 |  | Foreign key to hra_tmpl_periods_b. |
| CUSTOMARY_NAME | VARCHAR2 | 240 |  |  | Customary name of Template Periods. |
...
|---|---|---|---|
| HRA_DATA_INTEG_CHECKS_N1 | Non Unique | Default | TMPL_PERIOD_ID, REQUEST_ID, TABLE_NAME |
| HRA_DATA_INTEG_CHECKS_N2 | Non Unique | Default | LAST_UPDATE_DATE |
| HRA_DATA_INTEG_CHECKS_PK | Unique | Default | DATA_INTEG_CHECK_ID |
