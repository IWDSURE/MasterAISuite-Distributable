...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hraevalsections-19816.html#hraevalsections-19816](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hraevalsections-19816.html#hraevalsections-19816)

## Primary Key

| Name | Columns |
|------|----------|
| HRA_EVAL_SECTIONS_PK | EVAL_SECTION_ID |
...
| SECTION_TYPE_CODE | VARCHAR2 | 30 |  | Yes | Indicates the type of the section |
...
|---|---|---|---|
| HRA_EVAL_SECTIONS_N2 | Non Unique | Default | EVALUATION_ID, SECTION_TYPE_CODE, SECTION_RATING_MODEL_ID |
| HRA_EVAL_SECTIONS_PK | Unique | Default | EVAL_SECTION_ID |
