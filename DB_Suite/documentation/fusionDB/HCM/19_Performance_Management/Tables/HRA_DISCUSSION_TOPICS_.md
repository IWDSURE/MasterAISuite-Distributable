...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hradiscussiontopics-14131.html#hradiscussiontopics-14131](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hradiscussiontopics-14131.html#hradiscussiontopics-14131)

## Primary Key

| Name | Columns |
|------|----------|
| HRA_DISCUSSION_TOPICS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, DISCUSSION_TOPIC_ID, BUSINESS_GROUP_ID |
...
| CHECK_IN_MEETING_ID | NUMBER |  | 18 |  | Foreign key to HRA_CHECK_IN_MEETINGS |
...
| TOPIC_TYPE | VARCHAR2 | 240 |  |  | Discussion Topic Type of the Check-In meeting |
...
|---|---|---|---|
| HRA_DISCUSSION_TOPICSN1_ | Non Unique | Default | DISCUSSION_TOPIC_ID, BUSINESS_GROUP_ID, LAST_UPDATE_DATE |
| HRA_DISCUSSION_TOPICS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, DISCUSSION_TOPIC_ID, BUSINESS_GROUP_ID |
