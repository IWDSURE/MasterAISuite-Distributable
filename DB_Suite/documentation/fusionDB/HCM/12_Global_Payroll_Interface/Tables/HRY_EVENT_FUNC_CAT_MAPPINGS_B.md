...
Event Functional Categories Base Table Details.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hryeventfunccatmappingsb-28330.html#hryeventfunccatmappingsb-28330](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hryeventfunccatmappingsb-28330.html#hryeventfunccatmappingsb-28330)

## Primary Key

| Name | Columns |
|------|----------|
| HRY_EVENT_FUNC_CAT_MAP_PK | EVENT_FUNC_CAT_MAP_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| EVENT_FUNC_CAT_MAP_ID | NUMBER |  | 18 | Yes | Primary key column. Generates unique ID. |
| EVENT_CATEGORY_ID | NUMBER |  | 18 |  | Foreign key mapping to HRY_EVENT_CATEGORIES table |
| EVENT_FUNC_CAT_BASE_NAME | VARCHAR2 | 80 |  |  | Base Name of the Event Functional Category. |
...
|---|---|---|---|
| HRY_EVENT_FUNC_CAT_MAP_PK | Unique | Default | EVENT_FUNC_CAT_MAP_ID, ORA_SEED_SET1 |
| HRY_EVENT_FUNC_CAT_MAP_PK1 | Unique | Default | EVENT_FUNC_CAT_MAP_ID, ORA_SEED_SET2 |
