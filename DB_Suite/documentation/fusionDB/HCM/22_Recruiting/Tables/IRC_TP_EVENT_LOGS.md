...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/irctpeventlogs-20629.html#irctpeventlogs-20629](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/irctpeventlogs-20629.html#irctpeventlogs-20629)

## Primary Key

| Name | Columns |
|------|----------|
| IRC_TP_EVENT_LOGS_PK | EVENT_ID |
...
| REQUEST_START_TIME | TIMESTAMP |  |  |  | Stores request start time |
| REQUEST_END_TIME | TIMESTAMP |  |  |  | Stores request end time |
...
|---|---|---|---|
| IRC_TP_EVENT_LOGS_FK1 | Non Unique | Default | PROVISIONING_ID |
| IRC_TP_EVENT_LOGS_N1 | Non Unique | Default | CATEGORY_CODE, CREATION_DATE |
| IRC_TP_EVENT_LOGS_PK | Unique | Default | EVENT_ID |
