...
Stores posting results from JD partners for a requisition
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ircjdreqpostresults-28419.html#ircjdreqpostresults-28419](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ircjdreqpostresults-28419.html#ircjdreqpostresults-28419)

## Primary Key

| Name | Columns |
|------|----------|
| IRC_JD_REQ_POST_RESULTS_PK | RESULT_ID |
...
| JOB_BOARD_NAME | VARCHAR2 | 500 |  | Yes | Stores the name of the job board to which requisition was posted |
...
|---|---|---|---|
| IRC_JD_REQ_POST_RESULTS_FK1 | Non Unique | Default | POSTING_ID |
| IRC_JD_REQ_POST_RESULTS_PK | Unique | Default | RESULT_ID |
