...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/irccxtemplatesettings-6866.html#irccxtemplatesettings-6866](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/irccxtemplatesettings-6866.html#irccxtemplatesettings-6866)

## Primary Key

| Name | Columns |
|------|----------|
| IRC_CX_TEMPLATE_SETTINGS_PK | SETTING_ID |
...
| TEMPLATE_ID | NUMBER |  | 18 | Yes | ID of parent site template which defines the layout of the site. |  |
...
|---|---|---|---|
| IRC_CX_TEMPLATE_SETTINGS_PK | Unique | Default | SETTING_ID |
| IRC_CX_TEMPLATE_SETTINGS_UK1 | Unique | Default | TEMPLATE_ID, SETTING_KEY |
