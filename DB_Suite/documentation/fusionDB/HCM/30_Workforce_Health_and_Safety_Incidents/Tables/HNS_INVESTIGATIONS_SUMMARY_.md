...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsinvestigationssummary-23948.html#hnsinvestigationssummary-23948](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsinvestigationssummary-23948.html#hnsinvestigationssummary-23948)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_INVESTIGATIONS_SUMMARY_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, INVESTIGATE_ID |
...
| INVESTIGATE_NO | VARCHAR2 | 32 |  |  | Unique user generated Investigation  Identifier. |
| INVESTIGATE_DATE | TIMESTAMP |  |  |  | The date the investigation was initiated by the investigation owner. |
...
| INVESTIGATE_SUMMARY | VARCHAR2 | 1000 |  |  | The user entered summary on the investigation. |
...
| TARGET_COMPLETION_DATE | TIMESTAMP |  |  |  | Target Completion date for an investigation. |
...
|---|---|---|---|---|
| HNS_INVEST_SUMMARY_UK1_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, INVESTIGATE_ID | Active |
| HNS_INVEST_SUMMARY_UK2_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, INVESTIGATE_NO | Active |
| HNS_INVEST_SUMMARYN1_ | Non Unique | Default | INVESTIGATE_ID, LAST_UPDATE_DATE |  |
| HNS_INVEST_SUMMARYN2_ | Non Unique | Default | INCIDENT_ID, LAST_UPDATE_DATE |  |
