...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsfireinceventdetail-6572.html#hnsfireinceventdetail-6572](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsfireinceventdetail-6572.html#hnsfireinceventdetail-6572)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_FIRE_INC_EVENT_DETAIL_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, FIRE_INC_EVT_DETAIL_ID |
...
|---|---|---|---|
| HNS_FIRE_INC_EVENT_DETAIL_UK1_ | Unique | FUSION_TS_TX_IDX | LAST_UPDATE_DATE, LAST_UPDATED_BY, FIRE_INC_EVT_DETAIL_ID |
| HNS_FIRE_INC_EVENT_DETLN1_ | Non Unique | Default | FIRE_INC_EVT_DETAIL_ID, LAST_UPDATE_DATE |
