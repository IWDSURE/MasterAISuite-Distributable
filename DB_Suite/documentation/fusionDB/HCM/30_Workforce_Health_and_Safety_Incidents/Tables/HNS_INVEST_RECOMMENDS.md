...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsinvestrecommends-21040.html#hnsinvestrecommends-21040](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsinvestrecommends-21040.html#hnsinvestrecommends-21040)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_INVEST_RECOMMENDS_PK | RECOMMEND_ID |
...
| FINDING_ID | NUMBER |  | 18 | Yes | Investigation Finding Identifier. Foreign key for HNS_INVEST_FINDINGS |
...
|---|---|---|---|
| HNS_INVEST_RECOMMENDS_N1 | Non Unique | FUSION_TS_TX_DATA | FINDING_ID |
| HNS_INVEST_RECOMMENDS_UK1 | Unique | FUSION_TS_TX_DATA | RECOMMEND_ID |
