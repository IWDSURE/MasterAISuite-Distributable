...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsincidentsdetail-31060.html#hnsincidentsdetail-31060](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsincidentsdetail-31060.html#hnsincidentsdetail-31060)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_INCIDENTS_DETAIL_PK | INCIDENT_DETAIL_ID |
...
| INCIDENT_ID | NUMBER |  | 18 | Yes | Incident identifier. Primary key for Incidents Summary table. | Active |
| INCIDENT_EVENT_CODE | VARCHAR2 | 30 |  | Yes | Unique Identifier for each Incident Event. Connect to FND_LOOKUP_VALUES_VL to get Incident Events. | Active |
| INCIDENT_EVENT_NO | VARCHAR2 | 32 |  | Yes | Unique user generated Incident Event Number. | Active |
...
| TARGET_COMPLETION_DATE | TIMESTAMP |  |  | Yes | Target completion date set for each incident event. | Active |
...
| INCIDENT_EVENT_SUMMARY | VARCHAR2 | 1000 |  | Yes | The Summary information entered by the reporter for each incident event. | Active |
...
| INCIDENT_EVENT_DATE | TIMESTAMP |  |  | Yes | INCIDENT_EVENT_DATE column : Date incident event was reported. | Active |
...
|---|---|---|---|---|
| HNS_INCIDENTS_DETAIL_N1 | Non Unique | FUSION_TS_TX_IDX | INCIDENT_ID | Active |
| HNS_INCIDENTS_DETAIL_UK1 | Unique | FUSION_TS_TX_IDX | INCIDENT_DETAIL_ID | Active |
