...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsvehinceventdetail-31608.html#hnsvehinceventdetail-31608](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsvehinceventdetail-31608.html#hnsvehinceventdetail-31608)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_VEH_INC_EVENT_DETAIL_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, VEH_INC_EVT_DETAIL_ID |
...
| VEHICLE_CLASSIFICATION_CODE | VARCHAR2 | 30 |  |  | Classification of Vehicle Incident Event.Lookup from FND_LOOKUP.ORA_HNS_VEH_EVT_CLASS_CODE. | Active |
...
|---|---|---|---|---|
| HNS_VEH_INC_EVENT_DETAILN1_ | Non Unique | Default | VEH_INC_EVT_DETAIL_ID, LAST_UPDATE_DATE |  |
| HNS_VEH_INC_EVENT_DETAIL_UK1_ | Unique | FUSION_TS_TX_IDX | LAST_UPDATE_DATE, LAST_UPDATED_BY, VEH_INC_EVT_DETAIL_ID | Active |
