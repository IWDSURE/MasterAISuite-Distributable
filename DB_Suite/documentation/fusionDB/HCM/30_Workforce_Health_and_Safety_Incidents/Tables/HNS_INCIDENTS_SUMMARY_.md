...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsincidentssummary-9368.html#hnsincidentssummary-9368](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsincidentssummary-9368.html#hnsincidentssummary-9368)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_INCIDENTS_SUMMARY_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, INCIDENT_ID |
...
| INCIDENT_NO | VARCHAR2 | 32 |  |  | User defined unique Incidents Identifier. |
| EMERGENCY_FLAG | VARCHAR2 | 1 |  |  | Is Emergency Flag.This column signifies whether the incident has an emergency. |
| CONFIDENTIAL_FLAG | VARCHAR2 | 1 |  |  | Is Confidential flag. This column signifies whether the incident is checked confidential. |
...
| INCIDENT_DATE | TIMESTAMP |  |  |  | The date the incident occured. This column is an user entered column. |
...
| REPTR_SPECIFIC_LOCATION | VARCHAR2 | 255 |  |  | Incident specific location reported by the reporter. |
...
| INCIDENT_SUMMARY | VARCHAR2 | 1000 |  |  | The Summary information entered by the reporter for the incident. |
...
| TARGET_COMPLETION_DATE | TIMESTAMP |  |  |  | Target completion date set for the incident. |
...
| INCIDENT_STATUS_CODE | VARCHAR2 | 30 |  |  | INCIDENT_STATUS_CODE column: Current Incident Status. Lookup to FND_LOOKUP STATUS. |
...
|---|---|---|---|
| HNS_INCIDENTS_SUMMARY_UK1_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, INCIDENT_NO |
| HNS_INCIDENTS_SUMMARY_UK2_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, INCIDENT_ID |
| HNS_INCI_SUMMARYN1_ | Non Unique | Default | INCIDENT_ID, LAST_UPDATE_DATE |
