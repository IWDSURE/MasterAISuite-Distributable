...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsconfigtl-13455.html#hnsconfigtl-13455](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsconfigtl-13455.html#hnsconfigtl-13455)

## Primary Key

| Name | Columns |
|------|----------|
| HNS_CONFIG_TL_PK | CONFIG_ID, LANGUAGE |
...
|---|---|---|---|
| HNS_CONFIG_TL_UK1 | Unique | FUSION_TS_SEED | CONFIG_ID, LANGUAGE, ORA_SEED_SET1 |
| HNS_CONFIG_TL_UK11 | Unique | FUSION_TS_SEED | CONFIG_ID, LANGUAGE, ORA_SEED_SET2 |
