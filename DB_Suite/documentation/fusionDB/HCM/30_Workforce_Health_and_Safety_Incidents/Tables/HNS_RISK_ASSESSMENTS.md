...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsriskassessments-12964.html#hnsriskassessments-12964](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hnsriskassessments-12964.html#hnsriskassessments-12964)

## Primary Key

| Name | Columns |
|------|----------|
| hns_risk_assessments_PK | RISK_ASSESSMENT_ID |
...
| TASK_ID | NUMBER |  | 18 | Yes | Task Assigned to the Risk Assessment. |
...
|---|---|---|---|
| hns_risk_assessments_U1 | Unique | Default | RISK_ASSESSMENT_ID |
