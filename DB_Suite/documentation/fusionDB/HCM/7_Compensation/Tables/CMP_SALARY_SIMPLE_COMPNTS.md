...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpsalarysimplecompnts-18943.html#cmpsalarysimplecompnts-18943](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpsalarysimplecompnts-18943.html#cmpsalarysimplecompnts-18943)

## Primary Key

| Name | Columns |
|------|----------|
| CMP_SALARY_SIMPLE_COMPNTS_PK | SIMPLE_SALARY_COMPNT_ID |
...
| SALARY_ID | NUMBER |  | 18 | Yes | Salary unique ID |
...
| BASIS_SIMPLE_COMPONENT_ID | NUMBER |  | 18 | Yes | Unique key of setup entity cmp_basis_simple_components |
...
| AMOUNT | NUMBER |  |  | Yes | Rate Amount which can be user entered or computed |
...
|---|---|---|---|
| CMP_SALARY_SIMPLE_COMPNTS_N1 | Non Unique | Default | SALARY_ID, ASSIGNMENT_ID |
| CMP_SALARY_SIMPLE_COMPNTS_N2 | Non Unique | Default | BASIS_SIMPLE_COMPONENT_ID, SALARY_ID |
| CMP_SALARY_SIMPLE_COMPNTS_N3 | Non Unique | Default | ASSIGNMENT_ID, SALARY_ID, BASED_ON_COMPONENT_CODE |
| CMP_SALARY_SIMPLE_COMPNTS_PK | Unique | Default | SIMPLE_SALARY_COMPNT_ID |
