...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpcwbsalaryrates-30834.html#cmpcwbsalaryrates-30834](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpcwbsalaryrates-30834.html#cmpcwbsalaryrates-30834)

## Primary Key

| Name | Columns |
|------|----------|
| CMP_CWB_SALARY_RATES_PK | PERSON_EVENT_ID, SALARY_PAY_COMPONENT_ID |
...
|---|---|---|---|
| CMP_CWB_SALARY_RATES_PK | Unique | Default | PERSON_EVENT_ID, SALARY_PAY_COMPONENT_ID |
| CMP_CWB_SALARY_RATES_U1 | Unique | Default | PERIOD_ID, PLAN_ID, ASSIGNMENT_ID, SALARY_PAY_COMPONENT_ID |
