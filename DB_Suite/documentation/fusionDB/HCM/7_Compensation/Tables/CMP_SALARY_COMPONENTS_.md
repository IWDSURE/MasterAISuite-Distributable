...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpsalarycomponents-26369.html#cmpsalarycomponents-26369](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/cmpsalarycomponents-26369.html#cmpsalarycomponents-26369)

## Primary Key

| Name | Columns |
|------|----------|
| CMP_SALARY_COMPONENTS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SALARY_COMPONENT_ID |
...
| BUSINESS_GROUP_ID | NUMBER |  | 18 |  | Foreign Key to HR_ALL_ORGANIZATION_UNITS_F |
| SALARY_ID | NUMBER |  | 18 |  | Foreign Key to CMP_SALARY. |
...
|---|---|---|---|
| CMP_SALARY_COMPONENTSN1_ | Non Unique | Default | SALARY_COMPONENT_ID |
| CMP_SALARY_COMPONENTSN2_ | Non Unique | Default | AUDIT_ACTION_TYPE_ |
| CMP_SALARY_COMPONENTS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SALARY_COMPONENT_ID |
| CMP_SALARY_COMPONENTS_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SALARY_ID, COMPONENT_REASON_CODE |
