...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrmplancandidates-21092.html#hrmplancandidates-21092](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrmplancandidates-21092.html#hrmplancandidates-21092)

## Primary Key

| Name | Columns |
|------|----------|
| HRM_PLAN_CANDIDATES_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTERPRISE_ID, PLAN_CANDIDATE_ID, DATE_FROM |
...
| PLAN_ID | NUMBER |  | 18 |  | The succession plan where the person is listed as an candidate. |
| PERSON_ID | NUMBER |  | 18 |  | PERSON_ID of the plan candidate. |
| STATUS | VARCHAR2 | 30 |  |  | The candidates current status on the succession plan |
...
| CANDIDATE_TYPE | VARCHAR2 | 30 |  |  | The Candidate Type. Its is used to identify if the candidate is internal or external. |
...
| LATEST_RECORD_FLAG | VARCHAR2 | 1 |  |  | Latest record flag indicates the latest-active snapshot. |
...
|---|---|---|---|
| HRM_PLAN_CANDIDATESN1_ | Non Unique | Default | ENTERPRISE_ID, PLAN_CANDIDATE_ID, DATE_FROM, LAST_UPDATE_DATE |
| HRM_PLAN_CANDIDATES_PK_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTERPRISE_ID, PLAN_CANDIDATE_ID, DATE_FROM |
| HRM_PLAN_CANDIDATES_UK1_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTERPRISE_ID, PLAN_ID, PERSON_ID, EXTERNAL_CANDIDATE_ID, DATE_FROM |
