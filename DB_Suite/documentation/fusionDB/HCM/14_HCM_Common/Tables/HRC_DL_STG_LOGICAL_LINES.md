...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdlstglogicallines-14322.html#hrcdlstglogicallines-14322](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdlstglogicallines-14322.html#hrcdlstglogicallines-14322)

## Primary Key

| Name | Columns |
|------|----------|
| HRC_DL_STG_LOGICAL_LINES_PK | LOGICAL_LINE_ID |
...
| ROLLBACK_STATUS | VARCHAR2 | 32 |  |  | ROLLBACK_STATUS |
...
|---|---|---|---|
| HRC_DL_STG_LOGICAL_LINES_N1 | Non Unique | Default | DATA_SET_BUS_OBJ_ID |
| HRC_DL_STG_LOGICAL_LINES_N2 | Non Unique | Default | PARENT_LOGICAL_LINE_ID |
| HRC_DL_STG_LOGICAL_LINES_PK | Unique | Default | LOGICAL_LINE_ID |
