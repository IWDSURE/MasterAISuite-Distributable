...
**Tablespace:** hrc_dl_bo_role_map_

**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdlborolemap-14354.html#hrcdlborolemap-14354](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdlborolemap-14354.html#hrcdlborolemap-14354)

## Primary Key

| Name | Columns |
|------|----------|
| HRC_DL_BO_ROLE_MAP_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ROLE_MAPPING_ID |
...
|---|---|---|---|
| HRC_DL_BO_ROLE_MAP_N1_ | Non Unique | HRC_DL_BO_ROLE_MAP_N1_ | ROLE_ID |
| HRC_DL_BO_ROLE_MAP_N2_ | Non Unique | HRC_DL_BO_ROLE_MAP_N2_ | BUSINESS_OBJECT_ID, PRODUCT_AREA, ALL_BUS_OBJ_ACCESS, ALL_UNRESTRICTED_OBJ |
| HRC_DL_BO_ROLE_MAP_PK_ | Unique | HRC_DL_BO_ROLE_MAP_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ROLE_MAPPING_ID |
