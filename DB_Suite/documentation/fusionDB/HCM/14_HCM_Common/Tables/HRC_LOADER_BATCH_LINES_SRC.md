...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcloaderbatchlinessrc-15310.html#hrcloaderbatchlinessrc-15310](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcloaderbatchlinessrc-15310.html#hrcloaderbatchlinessrc-15310)

## Primary Key

| Name | Columns |
|------|----------|
| HRC_LOADER_BATCH_LINES_SRC_PK | BATCH_LINE_ID |
...
|---|---|---|---|
| HRC_LOADER_BATCH_LINES_SRC_N1 | Non Unique | Default | LOADER_BATCH_ID, LEVEL_ID_01, JOB_ID |
| HRC_LOADER_BATCH_LINES_SRC_PK | Unique | Default | BATCH_LINE_ID |
