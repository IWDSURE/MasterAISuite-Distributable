...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdllogicallines-15982.html#hrcdllogicallines-15982](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrcdllogicallines-15982.html#hrcdllogicallines-15982)

## Primary Key

| Name | Columns |
|------|----------|
| HRC_DL_LOGICAL_LINES_PK | LOGICAL_LINE_ID |
...
| KEY_SURROGATE_ID | NUMBER |  | 18 |  | KEY_SURROGATE_ID |
| KEY_GUID | RAW | 16 |  |  | KEY_GUID |
| ROOT_UI_USER_KEY | VARCHAR2 | 240 |  |  | ROOT_UI_USER_KEY |

## Indexes

| Index | Uniqueness | Tablespace | Columns |
|---|---|---|---|
| HRC_DL_LOGICAL_LINES_N1 | Non Unique | Default | DATA_SET_BUS_OBJ_ID, OBJECT_IDENTIFIER |
| HRC_DL_LOGICAL_LINES_N2 | Non Unique | Default | CHUNK_ID, PARENT_LOGICAL_LINE_ID, DATA_SET_BUS_OBJ_ID |
| HRC_DL_LOGICAL_LINES_N3 | Non Unique | Default | PARENT_LOGICAL_LINE_ID, DATA_SET_BUS_OBJ_ID |
| HRC_DL_LOGICAL_LINES_N4 | Non Unique | HRC_DL_LOGICAL_LINES_N4 | DATA_SET_BUS_OBJ_ID, ROOT_UI_USER_KEY |
| HRC_DL_LOGICAL_LINES_PK | Unique | Default | LOGICAL_LINE_ID |
