...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwrdocument-27740.html#hwrdocument-27740](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwrdocument-27740.html#hwrdocument-27740)

## Primary Key

| Name | Columns |
|------|----------|
| HWR_DOCUMENT_PK | DOCUMENT_ID |
...
|---|---|---|---|---|
| HWR_DOCUMENT_N1 | Non Unique | FUSION_TS_TX_DATA | DOC_CONTENT_ID |  |
| HWR_DOCUMENT_U1 | Unique | FUSION_TS_TX_DATA | DOCUMENT_ID | Active |
| HWR_DOCUMENT_U2 | Unique | FUSION_TS_TX_DATA | UUID | Active |
