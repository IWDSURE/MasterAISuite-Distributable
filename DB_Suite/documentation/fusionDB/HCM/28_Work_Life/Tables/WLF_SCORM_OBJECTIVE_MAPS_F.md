...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectivemapsf-4799.html#wlfscormobjectivemapsf-4799](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectivemapsf-4799.html#wlfscormobjectivemapsf-4799)

## Primary Key

| Name | Columns |
|------|----------|
| WLF_SCORM_OBJECTIVE_MAPS_PK | OBJECTIVE_MAP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| WLF_SCORM_OBJECTIVE_MAPS_N1 | Non Unique | Default | SEQUENCING_INFO_ID, OBJECTIVE_ID |
| WLF_SCORM_OBJECTIVE_MAPS_PK | Unique | FUSION_TS_TX_DATA | OBJECTIVE_MAP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
