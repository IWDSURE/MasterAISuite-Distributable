...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlflmcobjperformances-15355.html#wlflmcobjperformances-15355](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlflmcobjperformances-15355.html#wlflmcobjperformances-15355)

## Primary Key

| Name | Columns |
|------|----------|
| WLF_LMC_OBJ_PERFORMANCES_PK | OBJECTIVE_PERFORMANCE_ID |
...
|---|---|---|---|
| WLF_LMC_OBJ_PERFORMANCES_N1 | Non Unique | Default | PERSON_ID, OBJECTIVE_ID, CLASS_ID |
| WLF_LMC_OBJ_PERFORMANCES_PK | Unique | FUSION_TS_TX_DATA | OBJECTIVE_PERFORMANCE_ID |
