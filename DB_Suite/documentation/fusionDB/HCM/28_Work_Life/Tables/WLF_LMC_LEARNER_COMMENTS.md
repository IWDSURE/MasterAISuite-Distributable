...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlflmclearnercomments-7318.html#wlflmclearnercomments-7318](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlflmclearnercomments-7318.html#wlflmclearnercomments-7318)

## Primary Key

| Name | Columns |
|------|----------|
| WLF_LMC_LEARNER_COMMENTS_PK | LEARNER_COMMENT_ID |
...
|---|---|---|---|
| WLF_LMC_LEARNER_COMMENTS_N1 | Non Unique | Default | ATTEMPT_ID, COMMENT_SEQUENCE |
| WLF_LMC_LEARNER_COMMENTS_PK | Unique | FUSION_TS_TX_DATA | LEARNER_COMMENT_ID |
