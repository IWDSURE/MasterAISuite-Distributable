...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectivesf-14269.html#wlfscormobjectivesf-14269](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectivesf-14269.html#wlfscormobjectivesf-14269)

## Primary Key

| Name | Columns |
|------|----------|
| WLF_SCORM_OBJECTIVES_PK | OBJECTIVE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| WLF_SCORM_OBJECTIVES_N1 | Non Unique | Default | SEQUENCING_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, EXTERNAL_IDENTIFIER |
| WLF_SCORM_OBJECTIVES_PK | Unique | FUSION_TS_TX_DATA | OBJECTIVE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
