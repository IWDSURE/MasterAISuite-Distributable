...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectiveattempts-4921.html#wlfscormobjectiveattempts-4921](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/wlfscormobjectiveattempts-4921.html#wlfscormobjectiveattempts-4921)

## Primary Key

| Name | Columns |
|------|----------|
| WLF_SCORM_OBJ_ATTEMPTS_PK | OBJECTIVE_ATTEMPT_ID |
...
|---|---|---|---|
| WLF_SCORM_OBJ_ATTEMPTS_N1 | Non Unique | Default | ATTEMPT_INTERACTION_ID, OBJECTIVE_ID |
| WLF_SCORM_OBJ_ATTEMPTS_PK | Unique | FUSION_TS_TX_DATA | OBJECTIVE_ATTEMPT_ID |
