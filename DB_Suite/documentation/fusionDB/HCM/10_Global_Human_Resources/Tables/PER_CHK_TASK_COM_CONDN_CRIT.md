# PER_CHK_TASK_COM_CONDN_CRIT

Table to store completion condition criteria for a task
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perchktaskcomcondncrit-28706.html#perchktaskcomcondncrit-28706](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perchktaskcomcondncrit-28706.html#perchktaskcomcondncrit-28706)

## Primary Key

| Name | Columns |
|------|----------|
| PER_CHK_TASK_COM_CONDN_CRIT_PK | TASK_COM_COND_CRITERIA_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments | Status |
|---|---|---|---|---|---|---|
| TASK_COM_COND_CRITERIA_ID | NUMBER |  | 18 | Yes | TASK_COM_COND_CRITERIA_ID |  |
...
| ITEM_SEQUENCE | VARCHAR2 | 5 |  | Yes | ITEM_SEQUENCE | Obsolete |
| ITEM_ROW_SEQUENCE | NUMBER |  | 5 | Yes | ITEM_ROW_SEQUENCE |  |
...
|---|---|---|---|
| PER_CHK_TASK_COM_CONDN_CRIT_PK | Unique | Default | TASK_COM_COND_CRITERIA_ID |
