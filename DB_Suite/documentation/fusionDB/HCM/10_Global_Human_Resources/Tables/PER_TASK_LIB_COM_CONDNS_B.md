# PER_TASK_LIB_COM_CONDNS_B

Table to store completion conditions for a task library task
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pertasklibcomcondnsb-16131.html#pertasklibcomcondnsb-16131](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pertasklibcomcondnsb-16131.html#pertasklibcomcondnsb-16131)

## Primary Key

| Name | Columns |
|------|----------|
| PER_TASK_LIB_COM_CONDNS_B_PK | TASK_LIB_COM_CONDITION_ID |
...
|---|---|---|---|
| PER_TASK_LIB_COM_CONDNS_B_PK | Unique | Default | TASK_LIB_COM_CONDITION_ID |
