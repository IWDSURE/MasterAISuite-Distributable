...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pernationalidentifiers-12065.html#pernationalidentifiers-12065](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pernationalidentifiers-12065.html#pernationalidentifiers-12065)

## Primary Key

| Name | Columns |
|------|----------|
| PER_NATIONAL_IDENTIFIERS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, NATIONAL_IDENTIFIER_ID |
...
| PERSON_ID | NUMBER |  | 18 |  | Person for whom the NID is recorded. |
...
|---|---|---|---|
| PER_NATIONAL_IDENTIFIERS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, NATIONAL_IDENTIFIER_ID |
| PNIN1_ | Non Unique | Default | NATIONAL_IDENTIFIER_ID |
