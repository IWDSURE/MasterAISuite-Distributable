...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersonaddrusagesf-26059.html#perpersonaddrusagesf-26059](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersonaddrusagesf-26059.html#perpersonaddrusagesf-26059)

## Primary Key

| Name | Columns |
|------|----------|
| PER_PERSON_ADDR_USAGES_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_ADDR_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| PERSON_ID | NUMBER |  | 18 |  | The person to whom the address belongs, refers to PER_PERSONS |
| BUSINESS_GROUP_ID | NUMBER |  | 18 |  | Identifier of Enterprise, used for multi-tenancy partitioning. Foreign key to HR_ORGANIZATION_UNITS. |
| ADDRESS_ID | NUMBER |  | 18 |  | The address which is owned by this usage record. |
...
|---|---|---|---|
| PER_PERSON_ADDR_USAGES_FN1_ | Non Unique | Default | PERSON_ADDR_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_PERSON_ADDR_USAGES_F_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_ADDR_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
