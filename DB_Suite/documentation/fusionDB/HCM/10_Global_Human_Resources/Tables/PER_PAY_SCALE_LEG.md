...
PER_PAY_SCALE_LEG stores the legislative attributes for a Pay Scale.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpayscaleleg-31715.html#perpayscaleleg-31715](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpayscaleleg-31715.html#perpayscaleleg-31715)

## Primary Key

| Name | Columns |
|------|----------|
| PER_PAY_SCALE_LEG_PK | PAY_SCALE_LEG_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PAY_SCALE_LEG_ID | NUMBER |  | 18 | Yes | System generated primary key column. |
| LEGISLATION_CODE | VARCHAR2 | 30 |  | Yes | Legislation code derived from Legal Entity. |
| PAY_SCALE_ID | NUMBER |  | 18 | Yes | Foreign Key to PER_PAY_SCALES table. |
...
| SEQUENCE_NUMBER | NUMBER |  | 8 |  | Included for storing sequence for Pay Scale Legislative data to maintain them in order |
...
|---|---|---|---|
| PER_PAY_SCALE_LEG_N1 | Non Unique | APPS_TS_TX_DATA | PAY_SCALE_ID |
| PER_PAY_SCALE_LEG_PK | Unique | Default | PAY_SCALE_LEG_ID |
