...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perallocatedtasks-24396.html#perallocatedtasks-24396](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perallocatedtasks-24396.html#perallocatedtasks-24396)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ALLOCATED_TASKS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ALLOCATED_TASK_ID |
...
| ALLOCATED_CHECKLIST_ID | NUMBER |  | 18 |  | Identifier of the allocated checklist to which the task belongs |
| TASK_NAME | VARCHAR2 | 240 |  |  | Name of the Allocated Task |
| DESCRIPTION | VARCHAR2 | 4000 |  |  | Description of the Allocated Task |
| MANDATORY_FLAG | VARCHAR2 | 30 |  |  | Indicates whether the task is mandatory to be completed |
...
|---|---|---|---|
| PATN1_ | Non Unique | Default | ALLOCATED_TASK_ID, LAST_UPDATE_DATE |
| PER_ALLOCATED_TASKS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ALLOCATED_TASK_ID |
