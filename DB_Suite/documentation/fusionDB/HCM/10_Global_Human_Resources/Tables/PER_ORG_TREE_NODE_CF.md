...
This table holds the column flattened data for tree nodes of a Organization tree hierarchy.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perorgtreenodecf-25269.html#perorgtreenodecf-25269](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perorgtreenodecf-25269.html#perorgtreenodecf-25269)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ORG_TREE_NODE_CF_PK | ENTERPRISE_ID, TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, CF_TREE_NODE_ID |
...
|---|---|---|---|
| PER_ORG_TREE_NODE_CF_N1 | Non Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, DEP0_TREE_NODE_ID |
| PER_ORG_TREE_NODE_CF_N2 | Non Unique | FUSION_TS_TX_DATA | DEP0_PK1_VALUE, TREE_VERSION_ID |
| PER_ORG_TREE_NODE_CF_PK | Unique | FUSION_TS_TX_DATA | ENTERPRISE_ID, TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, CF_TREE_NODE_ID |
