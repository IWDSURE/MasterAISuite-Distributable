# PER_ALLOC_TASK_COM_CONDNS_B

Table to store completion conditions for an allocated task
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peralloctaskcomcondnsb-17048.html#peralloctaskcomcondnsb-17048](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peralloctaskcomcondnsb-17048.html#peralloctaskcomcondnsb-17048)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ALLOC_TASK_COM_CONDNS_B_PK | ALLOC_TASK_COM_CONDITION_ID |
...
| TASK_COM_CONDITION_ID | NUMBER |  | 18 |  | TASK_COM_CONDITION_ID |
...
|---|---|---|---|
| PER_ALLOC_TASK_COM_CONDNS_B_PK | Unique | Default | ALLOC_TASK_COM_CONDITION_ID |
