# PER_CHK_ARCH_ALLOCATIONS

This table records the checklists allocated to a person. These may be copied from templates in PER_CHECKLISTS, but it is possible to override with values specific to the particular allocation.This table records the checklists allocated to a person. These may be copied from templates in PER_CHECKLISTS, but it is possible to override with values specific to the particular allocation.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perchkarchallocations-20897.html#perchkarchallocations-20897](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perchkarchallocations-20897.html#perchkarchallocations-20897)

## Primary Key

| Name | Columns |
|------|----------|
| PER_CHK_ARCH_ALLOCATIONS_PK | ALLOCATED_CHECKLIST_ID |
...
| BACKGROUND_THUMBNAIL_URL | VARCHAR2 | 400 |  |  | BACKGROUND_THUMBNAIL_URL |  |
| BACKGROUND_IMAGE_URL | VARCHAR2 | 400 |  |  | Background Image URL |  |
...
| PERSON_ID | NUMBER |  | 18 | Yes | Person Identifier for whom this checklist has been allocated | Active |
...
| ARCHIVED_BY | VARCHAR2 | 64 |  |  | ARCHIVED_BY |  |
| ARCHIVE_DATE | TIMESTAMP |  |  |  | ARCHIVE_DATE |  |
| PURGED_FLAG | VARCHAR2 | 4 |  |  | PURGED_FLAG |  |
| PURGED_DATE | TIMESTAMP |  |  |  | PURGED_DATE |  |
| PURGE_BY_DATE | DATE |  |  |  | PURGE_BY_DATE |  |
...
|---|---|---|---|
| PER_CHK_ARCH_ALLOCATIONS_N1 | Non Unique | Default | PURGED_FLAG, ARCHIVE_DATE, PURGE_OFFSET, CHECKLIST_CATEGORY |
| PER_CHK_ARCH_ALLOCATIONS_N2 | Non Unique | Default | CHECKLIST_ID, PERSON_ID |
| PER_CHK_ARCH_ALLOCATIONS_PK | Unique | FUSION_TS_TX_DATA | ALLOCATED_CHECKLIST_ID |
