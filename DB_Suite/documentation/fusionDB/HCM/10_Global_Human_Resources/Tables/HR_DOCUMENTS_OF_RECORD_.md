...
This table contains information about the audited data for document records.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrdocumentsofrecord-26318.html#hrdocumentsofrecord-26318](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrdocumentsofrecord-26318.html#hrdocumentsofrecord-26318)

## Primary Key

| Name | Columns |
|------|----------|
| HR_DOCUMENTS_OF_RECORD_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, DOCUMENTS_OF_RECORD_ID |
...
| PERSON_ID | NUMBER |  | 18 |  | Person against whom document has to be stored. |
| ASSIGNMENT_ID | NUMBER |  | 18 |  | Assignment against whom document has to be stored. |
| DOCUMENT_TYPE_ID | NUMBER |  | 18 |  | Identifies the type of document which is stored. It also determines the document category and subcategory it will be related to. |
...
|---|---|---|---|
| HR_DOCUMENTS_OF_RECORDN1_ | Non Unique | Default | DOCUMENTS_OF_RECORD_ID |
| HR_DOCUMENTS_OF_RECORD_PK_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, DOCUMENTS_OF_RECORD_ID |
| HR_DOCUMENTS_OF_RECORD_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_ID, DOCUMENT_TYPE_ID, DOCUMENT_CODE |
