...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perratevaluesf-15438.html#perratevaluesf-15438](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perratevaluesf-15438.html#perratevaluesf-15438)

## Primary Key

| Name | Columns |
|------|----------|
| PER_RATE_VALUES_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, RATE_VALUE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| RATE_ID | NUMBER |  | 18 |  | Foreign Key to PER_RATES_F table. |
| RATE_OBJECT_TYPE | VARCHAR2 | 30 |  |  | Stores GRADE/STEP, tells whether it's Grade Rate Value or Step Rate Value |
| RATE_OBJECT_ID | NUMBER |  | 18 |  | Stores grade_id for grade rate value,  grade_step_id for step rate value |
...
|---|---|---|---|
| PER_RATE_VALUES_FN1_ | Non Unique | Default | RATE_VALUE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_RATE_VALUES_FN2_ | Non Unique | Default | AUDIT_ACTION_TYPE_ |
| PER_RATE_VALUES_F_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, RATE_VALUE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
