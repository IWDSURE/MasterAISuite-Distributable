...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/percitizenships-10851.html#percitizenships-10851](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/percitizenships-10851.html#percitizenships-10851)

## Primary Key

| Name | Columns |
|------|----------|
| PER_CITIZENSHIPS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, CITIZENSHIP_ID |
...
| LEGISLATION_CODE | VARCHAR2 | 30 |  |  | The legislation code of the citizenship. |
...
|---|---|---|---|
| PCITN1_ | Non Unique | Default | CITIZENSHIP_ID |
| PER_CITIZENSHIPS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, CITIZENSHIP_ID |
