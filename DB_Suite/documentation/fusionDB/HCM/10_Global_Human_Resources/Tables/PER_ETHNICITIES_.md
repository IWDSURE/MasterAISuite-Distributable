...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perethnicities-18064.html#perethnicities-18064](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perethnicities-18064.html#perethnicities-18064)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ETHNICITIES_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ETHNICITY_ID |
...
| PERSON_ID | NUMBER |  | 18 |  | Person for whom the ethnicity is recorded. |
| BUSINESS_GROUP_ID | NUMBER |  | 18 |  | Identifier of Enterprise, used for multi-tenancy partitioning. Foreign key to HR_ORGANIZATION_UNITS. |
| LEGISLATION_CODE | VARCHAR2 | 30 |  |  | Legislation code derived from Legal Entity. |
| ETHNICITY | VARCHAR2 | 30 |  |  | Ethnicity, defined from lookup, and valid for the Legislation Code |
| PRIMARY_FLAG | VARCHAR2 | 30 |  |  | Flag to indicate which ethnicity for a person is primary within a Legislation Code |
...
|---|---|---|---|
| PER_ETHNICITIES_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ETHNICITY_ID |
| PETHN1_ | Non Unique | Default | ETHNICITY_ID |
