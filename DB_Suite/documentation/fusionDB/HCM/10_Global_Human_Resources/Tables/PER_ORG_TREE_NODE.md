...
Organization Hierarchy Tree Node Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perorgtreenode-9312.html#perorgtreenode-9312](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perorgtreenode-9312.html#perorgtreenode-9312)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ORG_TREE_NODE_PK | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID |
...
|---|---|---|---|
| PER_ORG_TREE_NODE_N02 | Non Unique | FUSION_TS_TX_DATA | TREE_CODE, ENTERPRISE_ID |
| PER_ORG_TREE_NODE_N03 | Non Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, REFERENCE_TREE_CODE, REFERENCE_TREE_VERSION_ID, ENTERPRISE_ID |
| PER_ORG_TREE_NODE_N04 | Non Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, PARENT_TREE_NODE_ID, ENTERPRISE_ID |
| PER_ORG_TREE_NODE_N05 | Non Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, ENTERPRISE_ID, PK1_START_VALUE, PK2_START_VALUE, PK3_START_VALUE, PK4_START_VALUE, PK5_START_VALUE |
| PER_ORG_TREE_NODE_N06 | Non Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, ENTERPRISE_ID, PARENT_PK1_VALUE, PARENT_PK2_VALUE, PARENT_PK3_VALUE, PARENT_PK4_VALUE, PARENT_PK5_VALUE |
| PER_ORG_TREE_NODE_N07 | Non Unique | FUSION_TS_TX_DATA | TREE_NODE_ID, ENTERPRISE_ID |
| PER_ORG_TREE_NODE_N09 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("PK1_START_VALUE"), TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID |
| PER_ORG_TREE_NODE_N13 | Non Unique | FUSION_TS_TX_DATA | PARENT_TREE_NODE_ID, PK1_START_VALUE, TREE_VERSION_ID, TREE_CODE, TREE_STRUCTURE_CODE |
| PER_ORG_TREE_NODE_PK | Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID |
