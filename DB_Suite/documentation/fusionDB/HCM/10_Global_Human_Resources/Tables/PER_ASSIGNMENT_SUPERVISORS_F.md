...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perassignmentsupervisorsf-21838.html#perassignmentsupervisorsf-21838](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perassignmentsupervisorsf-21838.html#perassignmentsupervisorsf-21838)
...
|---|---|---|---|---|
| PER_ASSIGNMENT_SUP_F_FK1 | Non Unique | Default | BUSINESS_GROUP_ID | Active |
| PER_ASSIGNMENT_SUP_F_N1 | Non Unique | Default | ASSIGNMENT_ID | Active |
| PER_ASSIGNMENT_SUP_F_N2 | Non Unique | Default | MANAGER_ID | Active |
| PER_ASSIGNMENT_SUP_F_N3 | Non Unique | Default | MANAGER_ASSIGNMENT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE | Active |
| PER_ASSIGNMENT_SUP_F_N4 | Non Unique | Default | PERSON_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE | Active |
