...
The table stores the status of job chunk progress.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexjobchunkrange-15350.html#hexjobchunkrange-15350](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexjobchunkrange-15350.html#hexjobchunkrange-15350)

## Primary Key

| Name | Columns |
|------|----------|
| HEX_JOB_CHUNK_RANGE_PK | JOB_ID, CHUNK_NUMBER |
...
| ESS_REQUEST_ID | NUMBER |  |  |  | The column indicates the process request id for the thread. |
...
|---|---|---|---|
| HEX_JOB_CHUNK_RANGE_N1 | Non Unique | FUSION_TS_TX_DATA | JOB_ID, CHUNK_PROCESS_STATUS |
| HEX_JOB_CHUNK_RANGE_PK | Unique | FUSION_TS_TX_DATA | JOB_ID, CHUNK_NUMBER |
