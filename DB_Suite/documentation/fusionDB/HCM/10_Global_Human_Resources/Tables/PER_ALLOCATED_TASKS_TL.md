...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perallocatedtaskstl-21707.html#perallocatedtaskstl-21707](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perallocatedtaskstl-21707.html#perallocatedtaskstl-21707)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ALLOCATED_TASKS_TL_PK | ALLOCATED_TASK_ID, LANGUAGE |
...
|---|---|---|---|
| PER_ALLOCATED_TASKS_TL_N1 | Non Unique | Default | UPPER("TASK_NAME") |
| PER_ALLOCATED_TASKS_TL_PK | Unique | Default | ALLOCATED_TASK_ID, LANGUAGE |
