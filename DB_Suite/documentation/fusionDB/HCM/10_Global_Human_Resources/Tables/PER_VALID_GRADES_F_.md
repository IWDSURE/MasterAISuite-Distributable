...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pervalidgradesf-31559.html#pervalidgradesf-31559](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pervalidgradesf-31559.html#pervalidgradesf-31559)

## Primary Key

| Name | Columns |
|------|----------|
| PER_VALID_GRADES_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, VALID_GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PER_VALID_GRADES_FN1_ | Non Unique | Default | VALID_GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_VALID_GRADES_F_PK_ | Unique | FUSION_TS_TX_DATA | LAST_UPDATE_DATE, LAST_UPDATED_BY, VALID_GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
