...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perperiodsofservice-4181.html#perperiodsofservice-4181](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perperiodsofservice-4181.html#perperiodsofservice-4181)
...
|---|---|---|---|---|
| PER_PERIODS_OF_SERVICE_FK1 | Non Unique | Default | BUSINESS_GROUP_ID | Active |
| PER_PERIODS_OF_SERVICE_FK2 | Non Unique | Default | REHIRE_AUTHORIZER_PERSON_ID |  |
| PER_PERIODS_OF_SERVICE_N2 | Non Unique | Default | TERMINATION_ACCEPTED_PERSON_ID | Active |
| PER_PERIODS_OF_SERVICE_N3 | Non Unique | Default | PERSON_ID, PERIOD_TYPE, LEGAL_ENTITY_ID | Active |
