...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/percolagreementsb-4507.html#percolagreementsb-4507](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/percolagreementsb-4507.html#percolagreementsb-4507)

## Primary Key

| Name | Columns |
|------|----------|
| PER_COL_AGREEMENTS_B_PK | COLLECTIVE_AGREEMENT_ID |
...
| UNION_CODE | VARCHAR2 | 30 |  |  | UNION_CODE |
| VALID_FROM | DATE |  |  | Yes | VALID_FROM |
...
|---|---|---|---|
| PER_COL_AGREEMENTS_B_N1 | Non Unique | Default | UPPER("IDENTIFICATION_CODE") |
| PER_COL_AGREEMENTS_B_PK | Unique | Default | COLLECTIVE_AGREEMENT_ID |
