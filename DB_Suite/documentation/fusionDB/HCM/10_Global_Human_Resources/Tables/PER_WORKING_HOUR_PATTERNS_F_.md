...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perworkinghourpatternsf-26989.html#perworkinghourpatternsf-26989](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perworkinghourpatternsf-26989.html#perworkinghourpatternsf-26989)

## Primary Key

| Name | Columns |
|------|----------|
| PER_WORKING_HOUR_PATTERNS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORKING_HOUR_PATTERN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| OBJECT | VARCHAR2 | 30 |  |  | The module, with which the Working Hour Patterns functionality is integrated. |
| OBJECT_ID | NUMBER |  | 18 |  | Foreign key to the module, with which the Working Hour Patterns functionality is integrated. |
...
|---|---|---|---|
| PWHPFN1_ | Non Unique | Default | WORKING_HOUR_PATTERN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PWHPF_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORKING_HOUR_PATTERN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
