...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersontypeusagesm-4442.html#perpersontypeusagesm-4442](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpersontypeusagesm-4442.html#perpersontypeusagesm-4442)

## Primary Key

| Name | Columns |
|------|----------|
| PER_PERSON_TYPE_USAGES_M_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_TYPE_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, EFFECTIVE_LATEST_CHANGE, EFFECTIVE_SEQUENCE |
...
| PERSON_ID | NUMBER |  | 18 |  | Person for whom this person type usage is recorded |
| PERSON_TYPE_ID | NUMBER |  | 18 |  | Identifies the flavor of non-worker person type |
...
| SYSTEM_PERSON_TYPE | VARCHAR2 | 30 |  |  | Identifies a system type (from lookup, allowed values EMP, APL, CWK, NONW) the person can be classed as at a given time. |
...
|---|---|---|---|
| PER_PERSON_TYPE_USAGES_M_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PERSON_TYPE_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, EFFECTIVE_LATEST_CHANGE, EFFECTIVE_SEQUENCE |
| PPTUMN1_ | Non Unique | Default | PERSON_TYPE_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, EFFECTIVE_LATEST_CHANGE, EFFECTIVE_SEQUENCE |
