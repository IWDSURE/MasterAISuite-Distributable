...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpeopleextrainfof-19146.html#perpeopleextrainfof-19146](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpeopleextrainfof-19146.html#perpeopleextrainfof-19146)

## Primary Key

| Name | Columns |
|------|----------|
| PER_PEOPLE_EXTRA_INFO_F_PK | PERSON_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| PERSON_ID | NUMBER |  | 18 | Yes | Person for whom the Extra Information is recorded |  |
| INFORMATION_TYPE | VARCHAR2 | 40 |  | Yes | Type of extra information. |  |
| PEI_ATTRIBUTE_CATEGORY | VARCHAR2 | 30 |  |  | Descriptive Flexfield: structure definition of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE1 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE2 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE3 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE4 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE5 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE6 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE7 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE8 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE9 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE10 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE11 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE12 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE13 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE14 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE15 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE16 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE17 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE18 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE19 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE20 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
...
| PEI_ATTRIBUTE21 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE22 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE23 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE24 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE25 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE26 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE27 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE28 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE29 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
| PEI_ATTRIBUTE30 | VARCHAR2 | 150 |  |  | Descriptive Flexfield: segment of the user descriptive flexfield. | Person EIT Attributes (PER_PERSON_EXTRA_INFO_EIT_DFF) |
...
|---|---|---|---|
| PER_PEOPLE_EXTRA_INFO_F_FK1 | Non Unique | Default | INFORMATION_TYPE |
| PER_PEOPLE_EXTRA_INFO_F_N50 | Non Unique | Default | PERSON_ID, INFORMATION_TYPE |
| PER_PEOPLE_EXTRA_INFO_F_PK | Unique | Default | PERSON_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
