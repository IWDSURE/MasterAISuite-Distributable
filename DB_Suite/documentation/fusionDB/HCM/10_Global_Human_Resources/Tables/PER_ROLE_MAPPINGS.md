...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perrolemappings-12648.html#perrolemappings-12648](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perrolemappings-12648.html#perrolemappings-12648)

## Primary Key

| Name | Columns |
|------|----------|
| PER_ROLE_MAPPINGS_PK | ROLE_MAPPING_ID |
...
| DATE_FROM | DATE |  |  | Yes | Date from which the Role Mapping is active. |
| DATE_TO | DATE |  |  |  | Date till when the Role Mapping is active. |
| MAPPING_NAME | VARCHAR2 | 255 |  | Yes | Name for the Role Mapping |
...
|---|---|---|---|
| PER_ROLE_MAPPINGS_FK1 | Non Unique | FUSION_TS_TX_DATA | BUSINESS_UNIT_ID |
| PER_ROLE_MAPPINGS_FK2 | Non Unique | FUSION_TS_TX_DATA | LEGAL_EMPLOYER_ID |
| PER_ROLE_MAPPINGS_FK3 | Non Unique | FUSION_TS_TX_DATA | DEPARTMENT_ID |
| PER_ROLE_MAPPINGS_FK4 | Non Unique | FUSION_TS_TX_DATA | JOB_ID |
| PER_ROLE_MAPPINGS_PK | Unique | FUSION_TS_TX_DATA | ROLE_MAPPING_ID |
