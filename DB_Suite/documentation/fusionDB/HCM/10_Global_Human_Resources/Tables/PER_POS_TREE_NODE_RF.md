...
Position Hierarchy Tree Node RF Table.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpostreenoderf-12613.html#perpostreenoderf-12613](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpostreenoderf-12613.html#perpostreenoderf-12613)

## Primary Key

| Name | Columns |
|------|----------|
| PER_POS_TREE_NODE_RF_PK | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID, RF_TREE_NODE_ID, ENTERPRISE_ID |
...
| DISTANCE | NUMBER |  | 18 | Yes | Distance between Node and its Ancestor. |
...
|---|---|---|---|
| PER_POS_TREE_NODE_RF_N1 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("PK1_VALUE"), TO_NUMBER("ANCESTOR_PK1_VALUE"), TREE_VERSION_ID |
| PER_POS_TREE_NODE_RF_N2 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("PK1_VALUE"), TREE_VERSION_ID, TREE_CODE, TREE_STRUCTURE_CODE |
| PER_POS_TREE_NODE_RF_N3 | Non Unique | FUSION_TS_TX_DATA | ANCESTOR_TREE_NODE_ID, TREE_VERSION_ID, TREE_CODE, TREE_STRUCTURE_CODE |
| PER_POS_TREE_NODE_RF_N4 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("ANCESTOR_PK1_VALUE"), TREE_VERSION_ID, TREE_CODE |
| PER_POS_TREE_NODE_RF_PK | Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID, RF_TREE_NODE_ID, ENTERPRISE_ID |
