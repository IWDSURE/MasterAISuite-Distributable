...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perjobsftl-6716.html#perjobsftl-6716](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perjobsftl-6716.html#perjobsftl-6716)

## Primary Key

| Name | Columns |
|------|----------|
| PER_JOBS_F_TL_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, JOB_ID, LANGUAGE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| NAME | VARCHAR2 | 240 |  |  | Denotes name for the Job. |  |
...
|---|---|---|---|
| PER_JOBS_F_TLN1_ | Non Unique | Default | JOB_ID, LANGUAGE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_JOBS_F_TL_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, JOB_ID, LANGUAGE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
