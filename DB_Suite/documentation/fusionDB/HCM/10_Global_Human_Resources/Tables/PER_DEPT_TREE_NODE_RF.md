...
Department Hierarchy Tree Node RF Table.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perdepttreenoderf-31607.html#perdepttreenoderf-31607](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perdepttreenoderf-31607.html#perdepttreenoderf-31607)

## Primary Key

| Name | Columns |
|------|----------|
| PER_DEPT_TREE_NODE_RF_PK | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID, RF_TREE_NODE_ID, ENTERPRISE_ID |
...
| RF_TREE_NODE_ID | VARCHAR2 | 32 |  | Yes | System generated ID for the tree node. |
...
| ANCESTOR_DATA_SOURCE_ID | VARCHAR2 | 32 |  |  | Foreign key to DATA_SOURCE_ID from FND_TS_DATA_SOURCE.Identifies the data source of this node's ancestor. |
...
| IS_LEAF | VARCHAR2 | 1 |  | Yes | Flag to indicate if this Node is a Leaf. |
...
|---|---|---|---|
| PER_DEPT_TREE_NODE_RF_N1 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("PK1_VALUE"), TO_NUMBER("ANCESTOR_PK1_VALUE"), TREE_VERSION_ID |
| PER_DEPT_TREE_NODE_RF_N2 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("PK1_VALUE"), TREE_VERSION_ID, TREE_CODE, TREE_STRUCTURE_CODE |
| PER_DEPT_TREE_NODE_RF_N3 | Non Unique | FUSION_TS_TX_DATA | ANCESTOR_TREE_NODE_ID, TREE_VERSION_ID, TREE_CODE, TREE_STRUCTURE_CODE |
| PER_DEPT_TREE_NODE_RF_N4 | Non Unique | FUSION_TS_TX_DATA | TO_NUMBER("ANCESTOR_PK1_VALUE"), TREE_VERSION_ID, TREE_CODE |
| PER_DEPT_TREE_NODE_RF_N5 | Non Unique | FUSION_TS_TX_DATA | PK1_VALUE |
| PER_DEPT_TREE_NODE_RF_PK | Unique | FUSION_TS_TX_DATA | TREE_STRUCTURE_CODE, TREE_CODE, TREE_VERSION_ID, TREE_NODE_ID, RF_TREE_NODE_ID, ENTERPRISE_ID |
