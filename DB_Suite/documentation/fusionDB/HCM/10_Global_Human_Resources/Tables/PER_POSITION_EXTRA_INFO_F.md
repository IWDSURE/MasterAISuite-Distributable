...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionextrainfof-29623.html#perpositionextrainfof-29623](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionextrainfof-29623.html#perpositionextrainfof-29623)

## Primary Key

| Name | Columns |
|------|----------|
| PER_POSITION_EXTRA_INFO_F_PK | POSITION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| POSITION_ID | NUMBER |  | 18 | Yes | Foreign Key to HR_ALL_POSITIONS_F table. | Active |
| INFORMATION_TYPE | VARCHAR2 | 40 |  | Yes | Tyoe of information contained in the record for Position. | Active |
...
|---|---|---|---|---|
| PER_POSITION_EXTRA_INFO_FK1 | Non Unique | FUSION_TS_TX_DATA | INFORMATION_TYPE | Active |
| PER_POSITION_EXTRA_INFO_F_PK | Unique | FUSION_TS_TX_DATA | POSITION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |  |
| PER_POSITION_EXTRA_INFO_N3 | Non Unique | FUSION_TS_TX_DATA | POSITION_ID, INFORMATION_TYPE | Active |
| PER_POS_EXTRA_INFO_F_N11 | Non Unique | Default | UPPER("POEI_INFORMATION1") |  |
| PER_POS_EXTRA_INFO_F_N12 | Non Unique | Default | UPPER("POEI_INFORMATION2") |  |
| PER_POS_EXTRA_INFO_F_N13 | Non Unique | Default | UPPER("POEI_INFORMATION3") |  |
| PER_POS_EXTRA_INFO_F_N14 | Non Unique | Default | UPPER("POEI_INFORMATION4") |  |
| PER_POS_EXTRA_INFO_F_N15 | Non Unique | Default | UPPER("POEI_INFORMATION5") |  |
| PER_POS_EXTRA_INFO_F_N16 | Non Unique | Default | POEI_INFORMATION6 |  |
| PER_POS_EXTRA_INFO_F_N17 | Non Unique | Default | POEI_INFORMATION7 |  |
| PER_POS_EXTRA_INFO_F_N18 | Non Unique | Default | POEI_INFORMATION8 |  |
| PER_POS_EXTRA_INFO_F_N19 | Non Unique | Default | POEI_INFORMATION9 |  |
| PER_POS_EXTRA_INFO_F_N20 | Non Unique | Default | POEI_INFORMATION10 |  |
| PER_POS_EXTRA_INFO_F_N31 | Non Unique | Default | POEI_INFORMATION_NUMBER1 |  |
| PER_POS_EXTRA_INFO_F_N32 | Non Unique | Default | POEI_INFORMATION_NUMBER2 |  |
| PER_POS_EXTRA_INFO_F_N33 | Non Unique | Default | POEI_INFORMATION_NUMBER3 |  |
| PER_POS_EXTRA_INFO_F_N34 | Non Unique | Default | POEI_INFORMATION_NUMBER4 |  |
| PER_POS_EXTRA_INFO_F_N35 | Non Unique | Default | POEI_INFORMATION_NUMBER5 |  |
| PER_POS_EXTRA_INFO_F_N41 | Non Unique | Default | POEI_INFORMATION_DATE1 |  |
| PER_POS_EXTRA_INFO_F_N42 | Non Unique | Default | POEI_INFORMATION_DATE2 |  |
| PER_POS_EXTRA_INFO_F_N43 | Non Unique | Default | POEI_INFORMATION_DATE3 |  |
| PER_POS_EXTRA_INFO_F_N44 | Non Unique | Default | POEI_INFORMATION_DATE4 |  |
| PER_POS_EXTRA_INFO_F_N45 | Non Unique | Default | POEI_INFORMATION_DATE5 |  |
