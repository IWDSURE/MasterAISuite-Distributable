...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perlocationextrainfof-3676.html#perlocationextrainfof-3676](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perlocationextrainfof-3676.html#perlocationextrainfof-3676)

## Primary Key

| Name | Columns |
|------|----------|
| PER_LOCATION_EXTRA_INFO_PK | LOCATION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| INFORMATION_TYPE | VARCHAR2 | 40 |  | Yes | Type of extra information for the location. |
...
|---|---|---|---|
| PER_LOCATION_EXTRA_INFO_F1 | Non Unique | FUSION_TS_TX_DATA | INFORMATION_TYPE |
| PER_LOCATION_EXTRA_INFO_N1 | Non Unique | FUSION_TS_TX_DATA | LOCATION_ID, INFORMATION_TYPE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_LOCATION_EXTRA_INFO_PK | Unique | FUSION_TS_TX_DATA | LOCATION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_LOCATION_EXTRA_INFO_U1 | Unique | Default | LAST_UPDATE_DATE, LOCATION_EXTRA_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_LOC_EXTRA_INFO_F_N11 | Non Unique | Default | UPPER("LEI_INFORMATION1") |
| PER_LOC_EXTRA_INFO_F_N12 | Non Unique | Default | UPPER("LEI_INFORMATION2") |
| PER_LOC_EXTRA_INFO_F_N13 | Non Unique | Default | UPPER("LEI_INFORMATION3") |
| PER_LOC_EXTRA_INFO_F_N14 | Non Unique | Default | UPPER("LEI_INFORMATION4") |
| PER_LOC_EXTRA_INFO_F_N15 | Non Unique | Default | UPPER("LEI_INFORMATION5") |
| PER_LOC_EXTRA_INFO_F_N16 | Non Unique | Default | LEI_INFORMATION6 |
| PER_LOC_EXTRA_INFO_F_N17 | Non Unique | Default | LEI_INFORMATION7 |
| PER_LOC_EXTRA_INFO_F_N18 | Non Unique | Default | LEI_INFORMATION8 |
| PER_LOC_EXTRA_INFO_F_N19 | Non Unique | Default | LEI_INFORMATION9 |
| PER_LOC_EXTRA_INFO_F_N20 | Non Unique | Default | LEI_INFORMATION10 |
| PER_LOC_EXTRA_INFO_F_N31 | Non Unique | Default | LEI_INFORMATION_NUMBER1 |
| PER_LOC_EXTRA_INFO_F_N32 | Non Unique | Default | LEI_INFORMATION_NUMBER2 |
| PER_LOC_EXTRA_INFO_F_N33 | Non Unique | Default | LEI_INFORMATION_NUMBER3 |
| PER_LOC_EXTRA_INFO_F_N34 | Non Unique | Default | LEI_INFORMATION_NUMBER4 |
| PER_LOC_EXTRA_INFO_F_N35 | Non Unique | Default | LEI_INFORMATION_NUMBER5 |
| PER_LOC_EXTRA_INFO_F_N41 | Non Unique | Default | LEI_INFORMATION_DATE1 |
| PER_LOC_EXTRA_INFO_F_N42 | Non Unique | Default | LEI_INFORMATION_DATE2 |
| PER_LOC_EXTRA_INFO_F_N43 | Non Unique | Default | LEI_INFORMATION_DATE3 |
| PER_LOC_EXTRA_INFO_F_N44 | Non Unique | Default | LEI_INFORMATION_DATE4 |
| PER_LOC_EXTRA_INFO_F_N45 | Non Unique | Default | LEI_INFORMATION_DATE5 |
