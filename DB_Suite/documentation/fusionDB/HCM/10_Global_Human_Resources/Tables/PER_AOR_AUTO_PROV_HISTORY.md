# PER_AOR_AUTO_PROV_HISTORY

This table holds records from PER_ASG_RESPONSIBILITIES as history of records impacted by auto provision ESS job. These records in the table can be used to rollback auto provision ESS job output.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peraorautoprovhistory-12941.html#peraorautoprovhistory-12941](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/peraorautoprovhistory-12941.html#peraorautoprovhistory-12941)

## Primary Key

| Name | Columns |
|------|----------|
| PER_AOR_AUTO_PROV_HISTORY_PK | ASG_RESPONSIBILITY_ID |
...
|---|---|---|---|
| PER_AOR_AUTO_PROV_HISTORY_N1 | Non Unique | Default | TEMPLATE_ID |
| PER_AOR_AUTO_PROV_HISTORY_PK | Unique | Default | ASG_RESPONSIBILITY_ID |
