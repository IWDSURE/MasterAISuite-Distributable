...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradesf-15584.html#pergradesf-15584](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/pergradesf-15584.html#pergradesf-15584)

## Primary Key

| Name | Columns |
|------|----------|
| PER_GRADES_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| GRADE_CODE | VARCHAR2 | 30 |  |  | Code of the grade. |
| GRADE_TYPE | VARCHAR2 | 30 |  |  | Type of the grade. |
| ACTIVE_STATUS | VARCHAR2 | 30 |  |  | Indicates if a grade is active or inactive. |
...
|---|---|---|---|
| PER_GRADES_FN1_ | Non Unique | Default | GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_GRADES_FN2_ | Non Unique | Default | AUDIT_ACTION_TYPE_ |
| PER_GRADES_F_PK_ | Unique | FUSION_TS_TX_IDX | LAST_UPDATE_DATE, LAST_UPDATED_BY, GRADE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_GRADES_F_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, BUSINESS_GROUP_ID, SET_ID, GRADE_CODE, EFFECTIVE_START_DATE |
