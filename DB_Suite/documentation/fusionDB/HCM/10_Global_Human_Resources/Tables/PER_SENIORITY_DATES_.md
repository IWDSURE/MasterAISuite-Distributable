...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/persenioritydates-9385.html#persenioritydates-9385](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/persenioritydates-9385.html#persenioritydates-9385)

## Primary Key

| Name | Columns |
|------|----------|
| PER_SENIORITY_DATES_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SENIORITY_DATE_ID |
...
| PERSON_ID | NUMBER |  | 18 |  | This is Mandatory Field and it stores Person Id. |
...
|---|---|---|---|
| PER_SENIORITY_DATES_N1_ | Non Unique | Default | PERSON_ID, SENIORITY_DATE_CODE, TRIGGERING_FIELD_NUMBER |
| PER_SENIORITY_DATES_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SENIORITY_DATE_ID |
| PSDN1_ | Non Unique | Default | SENIORITY_DATE_ID |
