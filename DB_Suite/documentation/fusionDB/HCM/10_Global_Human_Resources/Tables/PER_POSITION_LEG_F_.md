...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionlegf-26100.html#perpositionlegf-26100](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perpositionlegf-26100.html#perpositionlegf-26100)

## Primary Key

| Name | Columns |
|------|----------|
| PER_POSITION_LEG_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, POSITION_LEG_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PER_POSITION_LEG_FN1_ | Non Unique | Default | POSITION_LEG_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PER_POSITION_LEG_FN2_ | Non Unique | Default | AUDIT_ACTION_TYPE_ |
| PER_POSITION_LEG_F_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, POSITION_LEG_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
