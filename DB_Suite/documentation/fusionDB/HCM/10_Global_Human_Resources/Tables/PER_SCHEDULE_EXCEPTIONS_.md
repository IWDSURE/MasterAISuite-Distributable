...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perscheduleexceptions-5050.html#perscheduleexceptions-5050](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/perscheduleexceptions-5050.html#perscheduleexceptions-5050)

## Primary Key

| Name | Columns |
|------|----------|
| PER_SCHEDULE_EXCEPTIONS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SCHEDULE_EXCEPTION_ID |
...
|---|---|---|---|
| PER_SCHEDULE_EXCEPTIONS_U1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SCHEDULE_EXCEPTION_ID |
