...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/faiworkflowsb-22622.html#faiworkflowsb-22622](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/faiworkflowsb-22622.html#faiworkflowsb-22622)

## Primary Key

| Name | Columns |
|------|----------|
| FAI_WORKFLOWS_B_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORKFLOW_ID |
...
| VERSION | NUMBER |  | 9 |  | This column specifies the workflow version. |
...
| USE_CASE_ID | VARCHAR2 | 100 |  |  | Identify usecase of the workflow |
...
| STATUS | VARCHAR2 | 32 |  |  | This column provides status of the workflow. |
| ARCHITECTURE | VARCHAR2 | 200 |  |  | Architecture can be hierarchical, group, sequential, etc. |
| ACCESS_MODIFIER | VARCHAR2 | 200 |  |  | Access modifier of the workflow |
...
| FOLLOW_UP_PROMPT_ENABLED | VARCHAR2 | 1 |  |  | Whether follow up prompt is enabled. |
...
|---|---|---|---|
| FAI_WORKFLOWS_BN1_ | Non Unique | Default | WORKFLOW_ID |
| FAI_WORKFLOWS_BU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, WORKFLOW_ID |
