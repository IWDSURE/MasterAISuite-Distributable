...
Backup table for HWM_TM_REP_MSGS.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwmtmrepmsgsbkp-15832.html#hwmtmrepmsgsbkp-15832](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwmtmrepmsgsbkp-15832.html#hwmtmrepmsgsbkp-15832)

## Primary Key

| Name | Columns |
|------|----------|
| HWM_TM_REP_MSGS_BKP_PK | TM_REP_MSGS_ID |
...
|---|---|---|---|
| HWM_TM_REP_MSGS_BKP_N3 | Non Unique | Default | TM_BLDG_BLK_ID, TM_BLDG_BLK_VERSION |
| HWM_TM_REP_MSGS_BKP_N4 | Non Unique | Default | TM_BLDG_BLK_ID, DATE_TO |
| HWM_TM_REP_MSGS_BKP_U1 | Unique | Default | TM_REP_MSGS_ID |
