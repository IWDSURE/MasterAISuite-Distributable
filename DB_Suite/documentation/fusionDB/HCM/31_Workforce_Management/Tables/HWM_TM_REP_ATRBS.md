...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwmtmrepatrbs-28475.html#hwmtmrepatrbs-28475](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hwmtmrepatrbs-28475.html#hwmtmrepatrbs-28475)

## Primary Key

| Name | Columns |
|------|----------|
| HWM_TM_REP_ATRBS_PK | TM_REP_ATRB_ID |
...
|---|---|---|---|---|
| HWM_TM_REP_ATRBS_N2 | Non Unique | Default | ATTRIBUTE_NUMBER2, ATTRIBUTE_CATEGORY, TM_REP_ATRB_ID, ENTERPRISE_ID | Obsolete |
| HWM_TM_REP_ATRBS_N3 | Non Unique | Default | ATTRIBUTE_NUMBER3, ATTRIBUTE_CATEGORY, TM_REP_ATRB_ID, ENTERPRISE_ID |  |
| HWM_TM_REP_ATRBS_N4 | Non Unique | Default | ATTRIBUTE_NUMBER1, ATTRIBUTE_CATEGORY, TM_REP_ATRB_ID, ENTERPRISE_ID |  |
| HWM_TM_REP_ATRBS_U1 | Unique | FUSION_TS_TX_DATA | TM_REP_ATRB_ID |  |
| hwm_tm_rep_atrbs_N1 | Non Unique | Default | ATTRIBUTE_VARCHAR8, ATTRIBUTE_CATEGORY, TM_REP_ATRB_ID, ENTERPRISE_ID |  |
