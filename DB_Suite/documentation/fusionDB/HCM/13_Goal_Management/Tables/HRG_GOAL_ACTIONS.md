...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrggoalactions-23334.html#hrggoalactions-23334](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrggoalactions-23334.html#hrggoalactions-23334)

## Primary Key

| Name | Columns |
|------|----------|
| HRG_GOAL_ACTIONS_PK | GOAL_ACTION_ID |
...
| ACTION_NAME | VARCHAR2 | 240 |  | Yes | Name of the goal action |
| ACTION_TYPE_CODE | VARCHAR2 | 30 |  | Yes | Type of goal action |
...
|---|---|---|---|
| HRG_GOAL_ACTIONS_FK1 | Non Unique | Default | GOAL_ID |
| HRG_GOAL_ACTIONS_PK | Unique | Default | GOAL_ACTION_ID |
