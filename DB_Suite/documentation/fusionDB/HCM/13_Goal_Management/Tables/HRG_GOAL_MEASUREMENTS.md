...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrggoalmeasurements-9600.html#hrggoalmeasurements-9600](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hrggoalmeasurements-9600.html#hrggoalmeasurements-9600)

## Primary Key

| Name | Columns |
|------|----------|
| HRG_GOAL_MEASUREMENTS_PK | MEASUREMENT_ID |
...
| GOAL_ID | NUMBER |  | 18 | Yes | Goal id, a foreign key to HRG_GOALS table |
| MEASUREMENT_NAME | VARCHAR2 | 400 |  | Yes | Measurement Name |
...
|---|---|---|---|
| HRG_GOAL_MEASUREMENTS_FK1 | Non Unique | Default | GOAL_ID |
| HRG_GOAL_MEASUREMENTS_PK | Unique | Default | MEASUREMENT_ID |
