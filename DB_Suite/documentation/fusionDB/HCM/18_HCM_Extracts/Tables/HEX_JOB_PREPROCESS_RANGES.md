...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexjobpreprocessranges-14722.html#hexjobpreprocessranges-14722](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexjobpreprocessranges-14722.html#hexjobpreprocessranges-14722)

## Primary Key

| Name | Columns |
|------|----------|
| HEX_JOB_PREPROCESS_RANGES_PK | JOB_PREPROCESS_RANGE_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| JOB_PREPROCESS_RANGE_ID | NUMBER |  | 18 | Yes | The column indicates the unique sequence generated value. |
| PREPROCESS_JOB_ID | NUMBER |  | 18 | Yes | The column indicates the JOB_ID from the HEX_JOBS table. |
| PARENT_JOB_ID | NUMBER |  | 18 | Yes | The column indicates the parent job id for the current job. |
| CHUNK_PROCESS_STATUS | VARCHAR2 | 30 |  |  | The column indicates the current processing status of the chunk. |
| CHUNK_NUMBER | NUMBER |  | 18 | Yes | The column indicates the number of the chunk being processed. |
...
| GROUP_TAG_NUMBER | NUMBER |  | 18 |  | The column indicates the number reference for the parent child link. |
...
|---|---|---|---|
| HEX_JOB_PREPROCESS_RANGES_N1 | Non Unique | Default | PREPROCESS_JOB_ID, CHUNK_NUMBER |
| HEX_JOB_PREPROCESS_RANGES_PK | Unique | Default | JOB_PREPROCESS_RANGE_ID |
