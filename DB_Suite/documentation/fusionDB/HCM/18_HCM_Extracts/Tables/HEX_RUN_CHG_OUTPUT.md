...
The table stores the final output for custom and seeded changes only extracts.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunchgoutput-12044.html#hexrunchgoutput-12044](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunchgoutput-12044.html#hexrunchgoutput-12044)

## Primary Key

| Name | Columns |
|------|----------|
| HEX_RUN_CHG_OUTPUT_PK | CHGRUN_XML_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| CHGRUN_XML_ID | NUMBER |  |  | Yes | The column indicates a unique sequence generated value. |
...
|---|---|---|---|---|
| HEX_RUN_CHG_OUTPUT_N1 | Non Unique | Default | EXT_RUN_ID, CONTENT_TYPE, SEQ_NO |  |
| HEX_RUN_CHG_OUTPUT_N2 | Non Unique | Default | EXT_RUN_ID, ATTRIBUTE_CATEGORY, ATTRIBUTE1 | Obsolete |
| HEX_RUN_CHG_OUTPUT_PK | Unique | Default | CHGRUN_XML_ID |  |
