...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunseedoutput-27911.html#hexrunseedoutput-27911](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunseedoutput-27911.html#hexrunseedoutput-27911)

## Primary Key

| Name | Columns |
|------|----------|
| HEX_RUN_SEED_OUTPUT_PK | SEEDRUN_XML_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| SEEDRUN_XML_ID | NUMBER |  |  | Yes | The column indicates a unique sequence generated value. |
...
|---|---|---|---|---|
| HEX_RUN_SEED_OUTPUT_N1 | Non Unique | Default | EXT_RUN_ID, CONTENT_TYPE, SEQ_NO |  |
| HEX_RUN_SEED_OUTPUT_N2 | Non Unique | Default | EXT_RUN_ID, ATTRIBUTE_CATEGORY, ATTRIBUTE1 | Obsolete |
| HEX_RUN_SEED_OUTPUT_PK | Unique | Default | SEEDRUN_XML_ID |  |
