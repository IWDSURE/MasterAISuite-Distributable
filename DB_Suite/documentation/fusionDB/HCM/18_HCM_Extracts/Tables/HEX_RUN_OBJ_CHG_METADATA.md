# HEX_RUN_OBJ_CHG_METADATA

The table stores the metadata for objects.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunobjchgmetadata-29941.html#hexrunobjchgmetadata-29941](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/hexrunobjchgmetadata-29941.html#hexrunobjchgmetadata-29941)

## Primary Key

| Name | Columns |
|------|----------|
| HEX_RUN_OBJ_CHG_METADATA_PK | REPORT_CATEGORY_ID, EXT_RUN_OBJ_MET_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| EXT_RUN_OBJ_MET_ID | NUMBER |  |  | Yes | The column indicates a unique sequence generated value. |
...
| LATEST_RUN_SEQ_NO | NUMBER |  |  |  | The column indicates the version sequence of the object. |
...
|---|---|---|---|---|
| HEX_RUN_OBJ_CHG_METADATA_N1 | Non Unique | Default | REPORT_CATEGORY_ID, OBJECT_ID |  |
| HEX_RUN_OBJ_CHG_METADATA_N2 | Non Unique | Default | REPORT_CATEGORY_ID, ATTRIBUTE_CATEGORY, ATTRIBUTE1 | Obsolete |
| HEX_RUN_OBJ_CHG_METADATA_PK | Unique | Default | REPORT_CATEGORY_ID, EXT_RUN_OBJ_MET_ID |  |
