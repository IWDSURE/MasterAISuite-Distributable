...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwdircompdetailsf-21234.html#payshdwdircompdetailsf-21234](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwdircompdetailsf-21234.html#payshdwdircompdetailsf-21234)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_SHDW_DIR_COMP_DETAILS_F_PK | DIR_COMP_DETAIL_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PAY_SHDW_DIR_COMP_DETAILS_F_N1 | Non Unique | Default | DIR_CARD_COMP_ID |
| PAY_SHDW_DIR_COMP_DETAILS_F_PK | Unique | Default | DIR_COMP_DETAIL_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
