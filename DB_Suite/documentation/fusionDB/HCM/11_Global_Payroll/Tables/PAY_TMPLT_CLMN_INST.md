...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytmpltclmninst-10768.html#paytmpltclmninst-10768](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytmpltclmninst-10768.html#paytmpltclmninst-10768)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_TMPLT_CLMN_INST_PK | CLMN_INST_ID |
...
|---|---|---|---|
| PAY_TMPLT_CLMN_INST_FK1 | Non Unique | Default | ROW_INST_ID |
| PAY_TMPLT_CLMN_INST_N20 | Non Unique | Default | SGUID |
| PAY_TMPLT_CLMN_INST_PK | Unique | Default | CLMN_INST_ID |
