...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payvaluedefsf-27474.html#payvaluedefsf-27474](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payvaluedefsf-27474.html#payvaluedefsf-27474)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_VALUE_DEFS_F_PK | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| VBC_STRUCT_ID | NUMBER |  | 18 |  | VBC_STRUCT_ID |
...
|---|---|---|---|
| PAY_VALUE_DEFS_F_N2 | Non Unique | Default | BASE_NAME, LEGISLATION_CODE |
| PAY_VALUE_DEFS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFS_F_N3 | Non Unique | Default | BASE_VALUE_DEFN_ID, VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFS_F_N4 | Non Unique | Default | UPPER("BASE_NAME") |
| PAY_VALUE_DEFS_F_N5 | Non Unique | Default | PARENT_VALUE_DEFN_ID |
| PAY_VALUE_DEFS_F_N6 | Non Unique | Default | NVL("BASE_VALUE_DEFN_ID","VALUE_DEFN_ID") |
| PAY_VALUE_DEFS_F_N7 | Non Unique | Default | VALUE_GROUP_ID |
| PAY_VALUE_DEFS_F_PK | Unique | Default | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| PAY_VALUE_DEFS_F_PK1 | Unique | Default | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
