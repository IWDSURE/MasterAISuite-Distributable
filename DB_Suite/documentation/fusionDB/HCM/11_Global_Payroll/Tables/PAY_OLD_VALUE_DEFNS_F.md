...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payoldvaluedefnsf-28977.html#payoldvaluedefnsf-28977](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payoldvaluedefnsf-28977.html#payoldvaluedefnsf-28977)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_VALUE_DEFINITIONS_F_PK | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PAY_OLD_VALUE_DEFNS_F_PK | Unique | Default | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFINITIONS_F_N1 | Non Unique | Default | SOURCE_ID, SOURCE_TYPE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFINITIONS_F_N2 | Non Unique | Default | BASE_NAME, SOURCE_ID, LEGISLATION_CODE |
| PAY_VALUE_DEFINITIONS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFINITIONS_F_N3 | Non Unique | Default | BASE_VALUE_DEFN_ID, VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_VALUE_DEFINITIONS_F_N4 | Non Unique | Default | UPPER("BASE_NAME") |
| PAY_VALUE_DEFINITIONS_F_N5 | Non Unique | Default | PARENT_VALUE_DEFN_ID, SOURCE_ID, SOURCE_TYPE |
| PAY_VALUE_DEFINITIONS_F_N6 | Non Unique | Default | NVL("BASE_VALUE_DEFN_ID","VALUE_DEFN_ID") |
| PAY_VALUE_DEFINITIONS_F_N7 | Non Unique | Default | VALUE_GROUP_ID |
