...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytmpltrowinstgt-10458.html#paytmpltrowinstgt-10458](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytmpltrowinstgt-10458.html#paytmpltrowinstgt-10458)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_TMPLT_ROW_INST_GT_PK | ROW_INST_ID |
...
|---|---|---|
| PAY_TMPLT_ROW_INST_GT_PK | Unique | ROW_INST_ID |
| PAY_TMPLT_ROW_INST_N11 | Non Unique | TEMPLATE_ID |
| PAY_TMPLT_ROW_INST_N21 | Non Unique | TABLE_SEQUENCE_NUMBER |
