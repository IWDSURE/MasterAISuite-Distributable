...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paydircardcomponentsf-28679.html#paydircardcomponentsf-28679](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paydircardcomponentsf-28679.html#paydircardcomponentsf-28679)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_DIR_CARD_COMPONENTS_F_PK | DIR_CARD_COMP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PAY_DIR_CARD_COMPONENTS_F_N1 | Non Unique | Default | DIR_CARD_ID |
| PAY_DIR_CARD_COMPONENTS_F_N2 | Non Unique | Default | DIR_CARD_COMP_DEF_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_DIR_CARD_COMPONENTS_F_N3 | Non Unique | Default | PARENT_DIR_CARD_COMP_ID |
| PAY_DIR_CARD_COMPONENTS_F_N4 | Non Unique | Default | CREATOR_ID, CREATOR_TYPE |
| PAY_DIR_CARD_COMPONENTS_F_PK | Unique | Default | DIR_CARD_COMP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
