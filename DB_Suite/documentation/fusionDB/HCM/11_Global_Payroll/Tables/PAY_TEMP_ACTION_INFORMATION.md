...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytempactioninformation-13029.html#paytempactioninformation-13029](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/paytempactioninformation-13029.html#paytempactioninformation-13029)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_TEMP_ACTION_INFORMATION_PK | ACTION_INFORMATION_ID |
...
|---|---|---|---|
| PAY_TEMP_ACTION_INFORMATION_N1 | Non Unique | Default | ACTION_CONTEXT_ID, ACTION_CONTEXT_TYPE, PARENT_ACT_INFO_ID |
| PAY_TEMP_ACTION_INFORMATION_N2 | Non Unique | Default | REPORT_RECORD_ID, GROUP_LABEL_ID |
| PAY_TEMP_ACTION_INFORMATION_N3 | Non Unique | Default | REPORT_RECORD_ID, ACTION_CONTEXT_ID, ACTION_CONTEXT_TYPE |
| PAY_TEMP_ACTION_INFORMATION_N4 | Non Unique | Default | GROUP_LABEL_ID |
| PAY_TEMP_ACTION_INFORMATION_N5 | Non Unique | Default | PARENT_ACT_INFO_ID |
| PAY_TEMP_ACTION_INFORMATION_N6 | Non Unique | Default | ACTION_CONTEXT_ID, ACTION_CONTEXT_TYPE, ACTION_INFORMATION_CATEGORY |
| PAY_TEMP_ACTION_INFORMATION_N7 | Non Unique | Default | PAYROLL_ACTION_ID |
| PAY_TEMP_ACTION_INFORMATION_N8 | Non Unique | Default | REPORT_RECORD_ID, PERSON_ID |
| PAY_TEMP_ACTION_INFORMATION_PK | Unique | Default | ACTION_INFORMATION_ID |
