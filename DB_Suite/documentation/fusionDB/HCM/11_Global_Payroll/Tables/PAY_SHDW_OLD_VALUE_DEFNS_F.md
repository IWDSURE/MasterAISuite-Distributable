...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwoldvaluedefnsf-5523.html#payshdwoldvaluedefnsf-5523](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwoldvaluedefnsf-5523.html#payshdwoldvaluedefnsf-5523)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_SHDW_VALUE_DEFNS_F_PK | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PAY_SHDW_OLD_VALUE_DEFNS_F_PK | Unique | Default | VALUE_DEFN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_SHDW_VALUE_DEFNS_F_N1 | Non Unique | Default | SOURCE_ID, SOURCE_TYPE, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| PAY_SHDW_VALUE_DEFNS_F_N2 | Non Unique | Default | BASE_NAME, SOURCE_ID, LEGISLATION_CODE |
