# PAY_SHDW_DIR_CARD_COMPONENTS_F
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwdircardcomponentsf-24046.html#payshdwdircardcomponentsf-24046](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/payshdwdircardcomponentsf-24046.html#payshdwdircardcomponentsf-24046)

## Primary Key

| Name | Columns |
|------|----------|
| PAY_SHDW_DIR_CARD_COMPS_F_PK | DIR_CARD_COMP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| PAY_SHDW_DIR_CARD_COMPS_F_N3 | Non Unique | Default | PARENT_DIR_CARD_COMP_ID |
| PAY_SHDW_DIR_CARD_COMPS_F_N4 | Non Unique | Default | CREATOR_ID, CREATOR_TYPE |
| PAY_SHDW_DIR_CARD_COMPS_F_PK | Unique | Default | DIR_CARD_COMP_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
