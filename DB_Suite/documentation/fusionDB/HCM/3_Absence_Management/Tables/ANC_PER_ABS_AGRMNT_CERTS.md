...
this table contain absence agreement and certification relation data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsagrmntcerts-8056.html#ancperabsagrmntcerts-8056](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsagrmntcerts-8056.html#ancperabsagrmntcerts-8056)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ABS_AGRMNT_CERTS_PK | PER_AGREEMENT_CERT_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PER_AGREEMENT_CERT_ID | NUMBER |  | 18 | Yes | Person Certification Evidence Identifier |
...
|---|---|---|---|
| ANC_PER_ABS_AGRMNT_CERTS_U1 | Unique | Default | PER_AGREEMENT_CERT_ID |
