...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsentrydtls-30915.html#ancperabsentrydtls-30915](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsentrydtls-30915.html#ancperabsentrydtls-30915)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ABS_ENTRY_DTLS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTERPRISE_ID, PER_ABS_ENTRY_DTL_ID |
...
|---|---|---|---|
| ANC_PER_ABS_ENTRY_DTLSN1_ | Non Unique | Default | ENTERPRISE_ID, PER_ABS_ENTRY_DTL_ID |
| ANC_PER_ABS_ENTRY_DTLS_UK1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTERPRISE_ID, PER_ABS_ENTRY_DTL_ID |
