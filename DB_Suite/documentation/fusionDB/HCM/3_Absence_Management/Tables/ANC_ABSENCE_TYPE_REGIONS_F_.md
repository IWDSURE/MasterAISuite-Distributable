...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetyperegionsf-4783.html#ancabsencetyperegionsf-4783](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetyperegionsf-4783.html#ancabsencetyperegionsf-4783)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_TYPE_REGIONS_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ENTERPRISE_ID | NUMBER |  | 18 |  | Enterprise id to which the absence type belongs. |
...
|---|---|---|---|
| ANC_ABSENCE_TYPE_REGIONS_FN1_ | Non Unique | Default | ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABSENCE_TYPE_REGIONS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
