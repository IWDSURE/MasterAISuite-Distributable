...
This Table store Absence Agreement data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsagrmnts-24033.html#ancperabsagrmnts-24033](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsagrmnts-24033.html#ancperabsagrmnts-24033)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ABS_AGRMNTS_PK | PER_AGREEMENT_ID, ENTERPRISE_ID |
...
| AGREEMENT_STATUS_CD | VARCHAR2 | 30 |  | Yes | STATUS |
| NOTICE_DATE | DATE |  |  |  | NOTICE_DATE |
| NOTICE_TYPE_CD | VARCHAR2 | 30 |  |  | NOTICE_TYPE_CD |
| NOTICE_PROVDR_CD | VARCHAR2 | 30 |  |  | NOTICE_PROVDR_CD |
| NOTICE_LATE_WAV_FLAG | VARCHAR2 | 30 |  |  | NOTICE_LATE_WAV_FLAG |
| NOTICE_TIMELY_FLAG | VARCHAR2 | 30 |  |  | NOTICE_TIMELY_FLAG |
| ABS_EVT_DTLS_FLAG | VARCHAR2 | 30 |  |  | Select Absence records for events details flag. |
| EVENT_TYPE_CD | VARCHAR2 | 30 |  |  | EVENT_TYPE_CD |
| SOURCE_ABS_RECORD_ID | NUMBER |  | 18 |  | SOURCE_ABS_RECORD_ID |
| TARGET_ABS_RECORD_ID | NUMBER |  | 18 |  | TARGET_ABS_RECORD_ID |
| EXPECTED_DT_CHILD_BIRTH | DATE |  |  |  | EXPECTED_DT_CHILD_BIRTH |
| SOURCE_LEAVE_START_DT | DATE |  |  |  | SOURCE LEAVE START DATE |
| SOURCE_LEAVE_END_DT | DATE |  |  |  | SOURCE LEAVE END DATE |
| ACTUAL_DT_CHILD_BIRTH | DATE |  |  |  | ACTUAL_DT_CHILD_BIRTH |
| EXPECTED_WK_CHILD_BIRTH | DATE |  |  |  | EXPECTED_WK_CHILD_BIRTH |
| MATCHING_PLCMNT_DT | DATE |  |  |  | MATCHING_PLCMNT_DT |
| ACTUAL_PLCMNT_DT | DATE |  |  |  | ACTUAL_PLCMNT_DT |
| EXPECTED_PLCMNT_DT | DATE |  |  |  | EXPECTED_PLCMNT_DT |
| AGREEMENT_START_DATE | DATE |  |  |  | AGREEMENT_START_DATE |
| AGREEMENT_END_DATE | DATE |  |  |  | AGREEMENT_END_DATE |
| DENY_RSN_CD | VARCHAR2 | 30 |  |  | DENY_RSN_CD |
| WITHDRAW_RSN_CD | VARCHAR2 | 30 |  |  | WITHDRAW_RSN_CD |
...
|---|---|---|---|
| ANC_PER_ABS_AGRMNTS_U1 | Unique | Default | PER_AGREEMENT_ID, ENTERPRISE_ID |
