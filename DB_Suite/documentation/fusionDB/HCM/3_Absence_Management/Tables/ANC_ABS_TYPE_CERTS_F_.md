...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypecertsf-28970.html#ancabstypecertsf-28970](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypecertsf-28970.html#ancabstypecertsf-28970)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_TYPE_CERTS_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ABSENCE_CERTIFICATION_ID | NUMBER |  | 18 |  | Absence Certification |
...
|---|---|---|---|
| ANC_ABS_TYPE_CERTS_FN1_ | Non Unique | Default | ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABS_TYPE_CERTS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
