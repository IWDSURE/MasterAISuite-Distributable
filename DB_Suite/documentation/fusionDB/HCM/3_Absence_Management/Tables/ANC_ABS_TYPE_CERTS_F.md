...
Absence Type Certifications Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypecertsf-12252.html#ancabstypecertsf-12252](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypecertsf-12252.html#ancabstypecertsf-12252)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_TYPE_CERTS_F_PK | ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ANC_ABS_TYPE_CERT_ID | NUMBER |  | 18 | Yes | Absence Type Certification |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ABSENCE_TYPE_ID | NUMBER |  | 18 | Yes | Absence Type |
| ABSENCE_CERTIFICATION_ID | NUMBER |  | 18 | Yes | Absence Certification |
| STATUS | VARCHAR2 | 240 |  |  | Absence Type Certification Status |
...
|---|---|---|---|
| ANC_ABS_TYPE_CERTS_F_N1 | Non Unique | Default | ABSENCE_TYPE_ID, EFFECTIVE_END_DATE |
| ANC_ABS_TYPE_CERTS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABS_TYPE_CERTS_F_U1 | Unique | Default | ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABS_TYPE_CERTS_F_U11 | Unique | Default | ANC_ABS_TYPE_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
