...
This table stores absence type - absence category intersection data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetypecatef-15052.html#ancabsencetypecatef-15052](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetypecatef-15052.html#ancabsencetypecatef-15052)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_TYPE_CATE_F_PK | ABSENCE_TYPE_CATE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABSENCE_TYPE_CATE_ID | NUMBER |  | 18 | Yes | Absence Type Category |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| ABSENCE_TYPE_ID | NUMBER |  | 18 |  | Absence Type |
| ABSENCE_CATEGORY_ID | NUMBER |  | 18 |  | Absence Category |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| STATUS | VARCHAR2 | 30 |  | Yes | Absence Type Category Status |
...
|---|---|---|---|
| ANC_ABSENCE_TYPE_CATE_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABSENCE_TYPE_CATE_F_U1 | Unique | Default | ABSENCE_TYPE_CATE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABSENCE_TYPE_CATE_F_U11 | Unique | Default | ABSENCE_TYPE_CATE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
