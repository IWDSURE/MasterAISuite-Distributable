...
This table stores absence type  usage rules data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsusagerulesf-21848.html#ancabsusagerulesf-21848](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsusagerulesf-21848.html#ancabsusagerulesf-21848)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_USAGE_RULES_F_PK | ABS_USAGE_RULE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABS_USAGE_RULE_ID | NUMBER |  | 18 | Yes | Absence Usage Rule |
| UNITS4 | NUMBER |  | 18 |  | Absence Usage Rules Units 4 |
| UNITS3 | NUMBER |  | 18 |  | Absence Usage Occurrence Limit |
| EVALUATION_CD | VARCHAR2 | 240 |  |  | Absence Occurrence Evaluation Period |
| RULE_UOM3 | VARCHAR2 | 240 |  |  | Absence Usage Rule Unit Of Measure 3 |
| REFERENCE_DATE_CD3 | VARCHAR2 | 240 |  |  | Absence Usage Rules Reference Date Code 3 |
| ANC_ABS_USAGE_RULES_F_ALTCD | VARCHAR2 | 240 |  |  | Absence Usage Rules Alternate Code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ABS_TYPE_RGN_USAGE_ID | NUMBER |  | 18 | Yes | Absence Type Region Usage |
| ACTION_CD | VARCHAR2 | 240 |  |  | Absence Usage Rules Action Code |
| CONDITION_CD1 | VARCHAR2 | 240 |  |  | Absence Usage Rules Condition Code 1 |
| REFERENCE_DATE_CD1 | VARCHAR2 | 240 |  |  | Absence Usage Rules Reference Date Code 1 |
| CALCULATION_CD1 | VARCHAR2 | 240 |  |  | Absence Usage Rules Calculation Code 1 |
| UNITS1 | NUMBER |  | 18 |  | Absence Usage Rules Units 1 |
| RULE_UOM1 | VARCHAR2 | 240 |  |  | Absence Usage Rule Unit Of Measure 1 |
| CONDITION_CD2 | VARCHAR2 | 240 |  |  | Absence Usage Rules Condition Code 2 |
| REFERENCE_DATE_CD2 | VARCHAR2 | 240 |  |  | Absence Usage Rules Reference Date Code 2 |
| CALCULATION_CD2 | VARCHAR2 | 240 |  |  | Absence Usage Rules Calculation Code 2 |
| UNITS2 | NUMBER |  | 18 |  | Absence Usage Rules Units 2 |
| RULE_UOM2 | VARCHAR2 | 240 |  |  | Absence Usage Rule Unit Of Measure 2 |
| UPDATE_FIELD_TYPE_CD | VARCHAR2 | 240 |  |  | Absence Usage Rules Update Field Type Code |
| UPDATE_CD | VARCHAR2 | 240 |  |  | Absence Usage Rules Update Code |
| FORMULA_ID | NUMBER |  | 18 |  | Absence Usage Rules Formula |
...
| REF_DATE_CD_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | REF_DATE_CD_LOOKUP_TYPE |
...
|---|---|---|---|
| ANC_ABS_USAGE_RULES_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABS_USAGE_RULES_F_U1 | Unique | Default | ABS_USAGE_RULE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABS_USAGE_RULES_F_U11 | Unique | Default | ABS_USAGE_RULE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
