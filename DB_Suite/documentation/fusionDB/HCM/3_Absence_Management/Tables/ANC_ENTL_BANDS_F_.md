...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsf-21890.html#ancentlbandsf-21890](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsf-21890.html#ancentlbandsf-21890)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ENTL_BANDS_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ANC_ENTL_BANDS_F_ALTCD | VARCHAR2 | 240 |  |  | Absence Entitlement Bands Alternate Code |
...
|---|---|---|---|
| ANC_ENTL_BANDS_FN1_ | Non Unique | Default | ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ENTL_BANDS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
