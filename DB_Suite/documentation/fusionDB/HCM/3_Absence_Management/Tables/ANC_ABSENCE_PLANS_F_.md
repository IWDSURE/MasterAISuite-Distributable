...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsenceplansf-4084.html#ancabsenceplansf-4084](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsenceplansf-4084.html#ancabsenceplansf-4084)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_PLANS_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ANC_ABSENCE_PLANS_F_ALTCD | VARCHAR2 | 240 |  |  | ANC_ABSENCE_PLANS_F_ALTCD |
...
|---|---|---|---|
| ANC_ABSENCE_PLANS_FN1_ | Non Unique | Default | ABSENCE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABSENCE_PLANS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
