...
Intersection table between events and absence type setup.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/anctypeeventsf-7738.html#anctypeeventsf-7738](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/anctypeeventsf-7738.html#anctypeeventsf-7738)

## Primary Key

| Name | Columns |
|------|----------|
| anc_type_events_f_PK | TYPE_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| ANC_TYPE_EVENTS_F_N1 | Non Unique | Default | EVENT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_TYPE_EVENTS_F_N20 | Non Unique | Default | EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_TYPE_EVENTS_F_U1 | Unique | Default | TYPE_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
