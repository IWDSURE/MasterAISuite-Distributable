...
Absence Types Regions Usages Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypergnusagesf-25381.html#ancabstypergnusagesf-25381](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabstypergnusagesf-25381.html#ancabstypergnusagesf-25381)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_TYPE_RGN_USAGES_F_PK | ABS_TYPE_RGN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABS_TYPE_RGN_USAGE_ID | NUMBER |  | 18 | Yes | ABS_TYPE_RGN_USAGE_ID |
| CWK_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | CWK_DISPLAY_USAGE_CD |
| CWK_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | CWK_LOOKUP_TYPE |
| CWK_USAGE_CD | VARCHAR2 | 30 |  |  | CWK_USAGE_CD |
| ANC_ABS_TYPE_RGN_USGS_F_ALTCD | VARCHAR2 | 240 |  |  | Absence Type Region Usage Alternate Code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | ENTERPRISE_ID |
| ABSENCE_TYPE_REGION_ID | NUMBER |  | 18 |  | ABSENCE_TYPE_REGION_ID |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ABSENCE_USAGE_CD | VARCHAR2 | 30 |  |  | ABSENCE_USAGE_CD |
| ABSENCE_FIELD_TYPE | VARCHAR2 | 30 |  |  | ABSENCE_FIELD_TYPE |
| EMP_USAGE_CD | VARCHAR2 | 30 |  |  | EMP_USAGE_CD |
| EMP_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | EMP_DISPLAY_USAGE_CD |
| EMP_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | EMP_LOOKUP_TYPE |
| MGR_USAGE_CD | VARCHAR2 | 30 |  |  | MGR_USAGE_CD |
| MGR_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | MGR_DISPLAY_USAGE_CD |
| MGR_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | MGR_LOOKUP_TYPE |
| ADMIN_USAGE_CD | VARCHAR2 | 30 |  |  | ADMIN_USAGE_CD |
| ADMIN_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | ADMIN_DISPLAY_USAGE_CD |
| ADMIN_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | ADMIN_LOOKUP_TYPE |
| APPROVAL_USAGE_CD | VARCHAR2 | 30 |  |  | APPROVAL_USAGE_CD |
| APPROVAL_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | APPROVAL_DISPLAY_USAGE_CD |
| APPROVAL_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | APPROVAL_LOOKUP_TYPE |
...
| ENABLE_RULE_EDIT | VARCHAR2 | 30 |  |  | ENABLE_RULE_EDIT |
| RULE_REF_DATE_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | RULE_REF_DATE_LOOKUP_TYPE |
...
|---|---|---|---|
| ANC_ABS_TYPE_RGN_USAGES_F_N1 | Non Unique | Default | ABSENCE_TYPE_REGION_ID, ABSENCE_USAGE_CD |
| ANC_ABS_TYPE_RGN_USAGES_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABS_TYPE_RGN_USAGES_F_PK | Unique | Default | ABS_TYPE_RGN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABS_TYPE_RGN_USAGES_F_PK1 | Unique | Default | ABS_TYPE_RGN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
