...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetypeplansf-31558.html#ancabsencetypeplansf-31558](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetypeplansf-31558.html#ancabsencetypeplansf-31558)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_TYPE_PLANS_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_TYPE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| ANC_ABSENCE_TYPE_PLANS_FN1_ | Non Unique | Default | ABSENCE_TYPE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABSENCE_TYPE_PLANS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, ABSENCE_TYPE_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
