...
This table holds information of absence regions in a absence type.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetyperegionsf-24864.html#ancabsencetyperegionsf-24864](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencetyperegionsf-24864.html#ancabsencetyperegionsf-24864)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_TYPE_REGIONS_F_PK | ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABSENCE_TYPE_REGION_ID | NUMBER |  | 18 | Yes | Absence type region id. This is a sequence generated value. |
| ANC_ABS_TYPE_RGN_F_ALTCD | VARCHAR2 | 240 |  |  | Absence Type Region Alternate Code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise id to which the absence type belongs. |
| ABSENCE_TYPE_ID | NUMBER |  | 18 |  | Absence type id. |
| ABSENCE_REGION_CD | VARCHAR2 | 30 |  |  | Absence region code. |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| EMP_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Employee displau usage code. This is used to control the display in UI |
| EMP_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Employee lookup code. |
| EMP_USAGE_CD | VARCHAR2 | 30 |  |  | Employee usage code. |
| MGR_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Manger display usage code.This is used to control the display in UI |
| CWK_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Contingent worker display usage code.This is used to control the display in UI |
| CWK_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Contingent worker lookup type. |
| CWK_USAGE_CD | VARCHAR2 | 30 |  |  | Contingent worker usage code. |
| MGR_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Manager lookup type. |
| MGR_USAGE_CD | VARCHAR2 | 30 |  |  | Manager usage code. |
| ADMIN_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Admin Lookup code. |
| ADMIN_USAGE_CD | VARCHAR2 | 30 |  |  | ADemin usage code. |
| ADMIN_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Admin display usage code.This is used to control the display in UI |
| APPROVAL_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Approval display usage code.This is used to control the display in UI. |
| APPROVAL_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Approval lookup type. |
| APPROVAL_USAGE_CD | VARCHAR2 | 30 |  |  | Approval usage code. |
...
|---|---|---|---|
| ANC_ABSENCE_TYPE_REGIONS_F_PK | Unique | Default | ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABSENCE_TYPE_REGIONS_F_PK1 | Unique | Default | ABSENCE_TYPE_REGION_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
| ANC_ABSENCE_TYPE_REGIONS_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABSENCE_TYPE_RGNS_F_N1 | Non Unique | Default | ABSENCE_TYPE_ID, ABSENCE_REGION_CD |
