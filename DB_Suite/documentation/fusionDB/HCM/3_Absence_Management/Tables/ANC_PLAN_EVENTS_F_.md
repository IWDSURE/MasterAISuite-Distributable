...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneventsf-26020.html#ancplaneventsf-26020](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneventsf-26020.html#ancplaneventsf-26020)

## Primary Key

| Name | Columns |
|------|----------|
| anc_plan_events_f_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
|---|---|---|---|
| ANC_PLAN_EVENTS_FN1_ | Non Unique | Default | PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_PLAN_EVENTS_FU1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
