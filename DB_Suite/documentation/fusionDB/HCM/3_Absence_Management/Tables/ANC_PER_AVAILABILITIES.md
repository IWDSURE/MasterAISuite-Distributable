# ANC_PER_AVAILABILITIES

Table to persist the availability related data.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperavailabilities-26276.html#ancperavailabilities-26276](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperavailabilities-26276.html#ancperavailabilities-26276)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_AVAILABILITIES_PK | ASSIGNMENT_AVAILABILITY_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ASSIGNMENT_AVAILABILITY_ID | NUMBER |  | 18 | Yes | Unique identifier for the availability assignment to a worker |
| PERSON_ID | NUMBER |  | 18 | Yes | PERSON_ID |
| ASSIGNMENT_ID | NUMBER |  | 18 | Yes | ASSIGNMENT_ID |
| AVAILABILITY_TYPE_ID | NUMBER |  | 18 | Yes | AVAILABILITY_TYPE_ID |
| DATE_FROM | DATE |  |  | Yes | Date from which the assignment of the availability is valid |
| DATE_TO | DATE |  |  |  | Date to which the assignment of the availability is valid |
| ANCHOR_DATE | DATE |  |  |  | Reference date that identifies which week's pattern applies to a given day, on a multi-week pattern. |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| REPEAT_NUM | NUMBER |  |  |  | Number of Repeating period |
| REPEAT_PERIOD | VARCHAR2 | 32 |  |  | Type of Repeating period |
...
|---|---|---|---|
| ANC_PER_AVAILABILITIES_N1 | Non Unique | Default | ASSIGNMENT_ID, DATE_FROM, DATE_TO |
| ANC_PER_AVAILABILITIES_N2 | Non Unique | Default | PERSON_ID, DATE_FROM, DATE_TO |
| ANC_PER_AVAILABILITIES_UK1 | Unique | Default | ASSIGNMENT_AVAILABILITY_ID |
