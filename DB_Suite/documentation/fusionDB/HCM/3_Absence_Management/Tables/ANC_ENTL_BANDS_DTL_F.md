...
Absence Entitlement Bands Detail Base Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsdtlf-22709.html#ancentlbandsdtlf-22709](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsdtlf-22709.html#ancentlbandsdtlf-22709)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ENTL_BANDS_DTL_F_PK | ENTL_BAND_DTL_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ENTL_BAND_DTL_ID | NUMBER |  | 18 | Yes | Entitlement Band Detail |
| ENTL_BAND_ID | NUMBER |  | 18 | Yes | Entitlement Band |
| ANC_ENTL_BANDS_DTL_F_ALTCD | VARCHAR2 | 240 |  | Yes | Absence Entitlement Band Detail Alternate Code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ENTL_BAND_DTL_SEQUENCE | NUMBER |  |  |  | Entitlement Band Detail Sequence |
| ENTL_DTL_OUTPUT_FORMULA_ID | NUMBER |  | 18 |  | Entitlement Details Output Formula |
| PAY_RATE_FACTOR | NUMBER |  |  |  | Pay Rate Factor |
...
|---|---|---|---|
| ANC_ENTL_BANDS_DTL_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ENTL_BANDS_DTL_F_PK | Unique | Default | ENTL_BAND_DTL_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ENTL_BANDS_DTL_F_PK1 | Unique | Default | ENTL_BAND_DTL_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
