# ANC_PER_CASE_BREAKDOWN

This Table store Absence case breakdown data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancpercasebreakdown-26832.html#ancpercasebreakdown-26832](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancpercasebreakdown-26832.html#ancpercasebreakdown-26832)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_CASE_BREAKDOWN_PK | PER_CASE_BREAKDOWN_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PER_CASE_BREAKDOWN_ID | NUMBER |  | 18 | Yes | PER_CASE_BREAKDOWN_ID |
| START_DATETIME | TIMESTAMP |  |  | Yes | START_DATETIME |
| END_DATETIME | TIMESTAMP |  |  | Yes | END_DATETIME |
| UNITS | NUMBER |  |  |  | UNITS |
| UOM | VARCHAR2 | 30 |  |  | UOM |
| PAY_FACTOR_WITHOUT_OVERRIDE | NUMBER |  |  |  | PAY_FACTOR_WITHOUT_OVERRIDE |
| PAY_FACTOR | NUMBER |  |  |  | PAY_FACTOR |
| CASE_ID | NUMBER |  | 18 | Yes | CASE_ID |
...
|---|---|---|---|
| ANC_PER_CASE_BREAKDOWN_N1 | Non Unique | Default | START_DATETIME |
| ANC_PER_CASE_BREAKDOWN_N2 | Non Unique | Default | PERSON_ID |
| ANC_PER_CASE_BREAKDOWN_N3 | Non Unique | Default | CASE_ID |
| ANC_PER_CASE_BREAKDOWN_U1 | Unique | Default | PER_CASE_BREAKDOWN_ID |
