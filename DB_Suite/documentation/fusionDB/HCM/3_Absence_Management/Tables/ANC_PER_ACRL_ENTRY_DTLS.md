...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperacrlentrydtls-17023.html#ancperacrlentrydtls-17023](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperacrlentrydtls-17023.html#ancperacrlentrydtls-17023)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ACRL_ENTRY_DTLS_PK | PER_ACCRUAL_ENTRY_DTL_ID |
...
|---|---|---|---|
| ANC_PER_ACRL_ENTRY_DTLS_N1 | Non Unique | Default | PER_ACCRUAL_ENTRY_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N10 | Non Unique | FUSION_TS_TX_IDX | ASSIGNMENT_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N2 | Non Unique | Default | PERSON_ID, PL_ID, PROCD_DATE |
| ANC_PER_ACRL_ENTRY_DTLS_N3 | Non Unique | Default | WORK_TERM_ASG_ID, PERSON_ID, PL_ID, PROCD_DATE |
| ANC_PER_ACRL_ENTRY_DTLS_N4 | Non Unique | Default | PER_ABSENCE_ENTRY_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N5 | Non Unique | Default | PER_ABS_TYPE_ENTRY_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N6 | Non Unique | Default | PER_PLAN_ENRT_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N7 | Non Unique | Default | COVR_ENTRY_DTL_ID, TYPE |
| ANC_PER_ACRL_ENTRY_DTLS_N8 | Non Unique | Default | ANC_PER_BEN_ELCTD_DISB_ID |
| ANC_PER_ACRL_ENTRY_DTLS_N9 | Non Unique | Default | RECIPIENT_PLAN_ENRT_ID |
| ANC_PER_ACRL_ENTRY_DTLS_U1 | Unique | FUSION_TS_TX_DATA | PER_ACCRUAL_ENTRY_DTL_ID |
