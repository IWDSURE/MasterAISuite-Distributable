...
Absence Plan Eligibility Profiles Base Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneligprofilesf-19717.html#ancplaneligprofilesf-19717](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneligprofilesf-19717.html#ancplaneligprofilesf-19717)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PLAN_ELIG_PROFILES_F_PK | PLAN_ELIG_PROFILE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PLAN_ELIG_PROFILE_ID | NUMBER |  | 18 | Yes | Plan Eligibility Profile |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| DON_PLAN_ELIG_PROFILE_TYPE | VARCHAR2 | 30 |  |  | Donation Plan Eligibility Profile Type |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| ABSENCE_PLAN_ID | NUMBER |  | 18 | Yes | Absence Plan |
| ANC_PLAN_ELIG_PROFILES_F_ALTCD | VARCHAR2 | 240 |  | Yes | Absence Plan Eligibility Profiles Alternate Code |
| BEN_ELIG_PROFILE_ID | NUMBER |  | 18 |  | Absence Plan Eligibility Profiles Benefits Eligibility Profile |
| ELIG_PROFILE_SEQUENCE | NUMBER |  |  |  | Absence Plan Eligibility Profiles Sequence |
| REQUIRED_FLAG | VARCHAR2 | 30 |  | Yes | Plan Eligibility Required Flag |
...
|---|---|---|---|
| ANC_PLAN_ELIG_PROFILES_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_PLAN_ELIG_PROFILES_F_PK | Unique | Default | PLAN_ELIG_PROFILE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_PLAN_ELIG_PROFILES_F_PK1 | Unique | Default | PLAN_ELIG_PROFILE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
