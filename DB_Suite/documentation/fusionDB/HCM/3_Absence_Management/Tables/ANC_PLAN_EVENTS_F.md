...
Intersection table between events and absence plan setup.
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneventsf-6986.html#ancplaneventsf-6986](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancplaneventsf-6986.html#ancplaneventsf-6986)

## Primary Key

| Name | Columns |
|------|----------|
| anc_plan_events_f_PK | PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PLAN_EVENTS_ID | NUMBER |  | 18 | Yes | Plan Events Id |
| EVENT_ID | NUMBER |  | 18 | Yes | Event Id |
| ABSENCE_PLAN_ID | NUMBER |  | 18 | Yes | Absence Plan Id |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise Id |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| PROC_TYPE | VARCHAR2 | 32 |  | Yes | Processing Type: ENRL, ACRL |
...
| ANC_CHAR1 | VARCHAR2 | 255 |  |  | Absence charecter column1 |
| ANC_CHAR2 | VARCHAR2 | 255 |  |  | Absence charecter column 2 |
| ANC_CHAR3 | VARCHAR2 | 255 |  |  | Absence charecter column 3 |
| ANC_CHAR4 | VARCHAR2 | 255 |  |  | Absence charecter column 4 |
| ANC_CHAR5 | VARCHAR2 | 255 |  |  | Absence Charecter column 5 |
...
| INFORMATION28 | VARCHAR2 | 20 |  |  | INFORMATION28 |
...
|---|---|---|---|
| ANC_PLAN_EVENTS_F_N1 | Non Unique | Default | EVENT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_PLAN_EVENTS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_PLAN_EVENTS_F_U1 | Unique | Default | PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_PLAN_EVENTS_F_U11 | Unique | Default | PLAN_EVENTS_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
