# ANC_PER_ABS_AGGREGATION

Table to capture aggregation information for each absence entry
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsaggregation-9485.html#ancperabsaggregation-9485](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsaggregation-9485.html#ancperabsaggregation-9485)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ABS_AGGREGATION_PK | ABS_AGGREGATION_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABS_AGGREGATION_ID | NUMBER |  | 18 | Yes | Primary key |
| PER_ABSENCE_ENTRY_ID | NUMBER |  | 18 | Yes | Represents the absence entry id for which this row corresponds to |
| AGGREGATION_TYPE | VARCHAR2 | 150 |  | Yes | Identifies the aggregation level |
| AGGREGATION_ID | NUMBER |  | 18 | Yes | Represents the aggregation id |
| AGGREGATION_NAME | VARCHAR2 | 150 |  | Yes | AGGREGATION_NAME |
| PROCESSING_STATUS | VARCHAR2 | 30 |  |  | To keep track of processing status of the record |
...
|---|---|---|---|
| ANC_PER_ABS_AGGREGATION_U1 | Unique | Default | ABS_AGGREGATION_ID |
| ANC_PER_ABS_AGGREGATION_U2 | Unique | Default | PER_ABSENCE_ENTRY_ID, AGGREGATION_TYPE, AGGREGATION_ID, AGGREGATION_NAME |
