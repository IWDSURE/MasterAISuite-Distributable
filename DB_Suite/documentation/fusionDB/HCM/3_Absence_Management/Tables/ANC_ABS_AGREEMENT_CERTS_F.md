...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsagreementcertsf-26202.html#ancabsagreementcertsf-26202](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsagreementcertsf-26202.html#ancabsagreementcertsf-26202)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_AGREEMENT_CERTS_F_PK | ANC_AGREEMENT_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ANC_AGREEMENT_CERT_ID | NUMBER |  | 18 | Yes | Agreement Certification Id |
| AGR_CERTIFICATE_BASE_NAME | VARCHAR2 | 240 |  |  | Agreement Certificate Base Name |
| ABS_AGREEMENT_CERTS_F_ALTCD | VARCHAR2 | 240 |  |  | Agreement Certification Alt code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ABSENCE_AGREEMENT_ID | NUMBER |  | 18 | Yes | Absence Type |
...
|---|---|---|---|
| ANC_ABS_AGREEMENT_CERTS_F_U1 | Unique | Default | ANC_AGREEMENT_CERT_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
