...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancaccrualbandsf-26143.html#ancaccrualbandsf-26143](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancaccrualbandsf-26143.html#ancaccrualbandsf-26143)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ACCRUAL_BANDS_F_PK | ACCRUAL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ANC_ACCRUAL_BANDS_F_ALTCD | VARCHAR2 | 240 |  | Yes | Accrual Bands Alternate Code |
...
|---|---|---|---|
| ANC_ACCRUAL_BANDS_F_N1 | Non Unique | Default | ABSENCE_PLAN_ID |
| ANC_ACCRUAL_BANDS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ACCRUAL_BANDS_F_PK | Unique | Default | ACCRUAL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ACCRUAL_BANDS_F_PK1 | Unique | Default | ACCRUAL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
