# ANC_PER_CASE_ABSENCES

This Table store Absence case absences data
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancpercaseabsences-3155.html#ancpercaseabsences-3155](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancpercaseabsences-3155.html#ancpercaseabsences-3155)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_CASE_ABSENCES_PK | PER_CASE_ABSENCE_ID |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| PER_CASE_ABSENCE_ID | NUMBER |  | 18 | Yes | PER_CASE_ABSENCE_ID |
...
|---|---|---|---|
| ANC_PER_CASE_ABSENCES_N1 | Non Unique | Default | PER_ABSENCE_ENTRY_ID |
| ANC_PER_CASE_ABSENCES_N2 | Non Unique | Default | PERSON_ID |
| ANC_PER_CASE_ABSENCES_N3 | Non Unique | Default | CASE_ID |
| ANC_PER_CASE_ABSENCES_U1 | Unique | Default | PER_CASE_ABSENCE_ID |
