...
Absence Pattern Regions Base Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencepatternrgnsf-21219.html#ancabsencepatternrgnsf-21219](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsencepatternrgnsf-21219.html#ancabsencepatternrgnsf-21219)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABSENCE_PATTERN_RGNS_F_PK | ABSENCE_PATTERN_RGN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABSENCE_PATTERN_RGN_ID | NUMBER |  | 18 | Yes | ABSENCE_PATTERN_RGN_ID |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| ABSENCE_PATTERN_ID | NUMBER |  | 18 |  | ABSENCE_PATTERN_ID |
| ABSENCE_REGION_ID | NUMBER |  | 18 |  | ABSENCE_REGION_ID |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| ABSENCE_REGION_CD | VARCHAR2 | 30 |  |  | ABSENCE_REGION_CD |
...
| EMP_DEFAULT_CD | VARCHAR2 | 30 |  |  | EMP_DEFAULT_CD |
| MGR_DEFAULT_CD | VARCHAR2 | 30 |  |  | MGR_DEFAULT_CD |
| ADMIN_DEFAULT_CD | VARCHAR2 | 30 |  |  | ADMIN_DEFAULT_CD |
| APPROVAL_DEFAULT_CD | VARCHAR2 | 30 |  |  | APPROVAL_DEFAULT_CD |
| PATTERN_RGNS_F_ALTCD | VARCHAR2 | 2000 |  |  | PATTERN_RGNS_F_ALTCD |
...
|---|---|---|---|
| ANC_ABSENCE_PATTERN_RGNS_F_PK | Unique | Default | ABSENCE_PATTERN_RGN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABSENCE_PATTERN_RGNS_F_PK1 | Unique | Default | ABSENCE_PATTERN_RGN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
| ANC_ABSENCE_PATTERN_RGNS_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
