...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsentries-13637.html#ancperabsentries-13637](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancperabsentries-13637.html#ancperabsentries-13637)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_PER_ABS_ENTRIES_PK | PER_ABSENCE_ENTRY_ID, ENTERPRISE_ID |
...
| ABSENCE_TYPE_ID | NUMBER |  | 18 | Yes | ABSENCE_TYPE |
| CHILD_EVENT_TYPE_CD | VARCHAR2 | 30 |  |  | Child event type code for Maternity |
| ABSENCE_TYPE_REASON_ID | NUMBER |  | 18 |  | ABSENCE_REASON |
| ABSENCE_ENTRY_BASIC_FLAG | VARCHAR2 | 30 |  | Yes | ABSENCE_PATTERN |
| ABSENCE_STATUS_CD | VARCHAR2 | 30 |  | Yes | ABSENCE_STATUS_CD |
...
| OPEN_ENDED_FLAG | VARCHAR2 | 1 |  | Yes | OPEN_ENDED_FLAG |
...
| USER_MODE | VARCHAR2 | 10 |  | Yes | Represents user interface absence is entered. User mode values are EMP, MGR, ADMIN, APPROVAL. |
| SOURCE | VARCHAR2 | 10 |  | Yes | Represents the source of absence. Values are 'ANC', 'TC', 'XLS'. |
...
|---|---|---|---|
| ANC_PER_ABS_ENTRIES_N1 | Non Unique | Default | ENTERPRISE_ID, LEGISLATIVE_DATA_GROUP_ID, LEGAL_ENTITY_ID |
| ANC_PER_ABS_ENTRIES_N2 | Non Unique | Default | PERSON_ID, START_DATETIME, END_DATETIME, ABSENCE_TYPE_ID |
| ANC_PER_ABS_ENTRIES_N4 | Non Unique | Default | ABSENCE_TYPE_ID, START_DATE, START_TIME |
| ANC_PER_ABS_ENTRIES_N5 | Non Unique | FUSION_TS_TX_IDX | PERIOD_OF_SERVICE_ID |
| ANC_PER_ABS_ENTRIES_N6 | Non Unique | FUSION_TS_TX_IDX | TIME_CARD_TRANSFER_STATUS |
| ANC_PER_ABS_ENTRIES_N7 | Non Unique | FUSION_TS_TX_IDX | ABSENCE_CASE_ID |
| ANC_PER_ABS_ENTRIES_UK1 | Unique | Default | PER_ABSENCE_ENTRY_ID, ENTERPRISE_ID |
