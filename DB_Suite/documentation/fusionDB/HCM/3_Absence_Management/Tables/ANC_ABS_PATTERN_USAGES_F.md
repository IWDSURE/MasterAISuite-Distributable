...
Absence Pattern Usages Base Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabspatternusagesf-26861.html#ancabspatternusagesf-26861](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabspatternusagesf-26861.html#ancabspatternusagesf-26861)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_PATTERN_USAGES_F_PK | ABSENCE_PATTERN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |

## Columns

| Name | Datatype | Length | Precision | Not-null | Comments |
|---|---|---|---|---|---|
| ABSENCE_PATTERN_USAGE_ID | NUMBER |  | 18 | Yes | Absence Pattern Usage |
...
| ABSENCE_PATTERN_ID | NUMBER |  | 18 |  | Absence Pattern |
| EMP_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Employee Display Usage Code |
| EMP_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Employee Lookup Type |
| CWK_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | CWK_LOOKUP_TYPE |
| CWK_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | CWK_DISPLAY_USAGE_CD |
| CWK_DEFAULT_CD | VARCHAR2 | 30 |  |  | CWK_DEFAULT_CD |
| MGR_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Manager Display Usage Code |
| MGR_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Manager Lookup Type |
| ADMIN_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Administrator Display Usage Code |
| ADMIN_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Administrator Lookup Code |
| APPROVAL_DISPLAY_USAGE_CD | VARCHAR2 | 30 |  |  | Approval Display Usage Code |
| APPROVAL_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Approval Lookup Type |
| ENABLE_FLAG | VARCHAR2 | 4 |  |  | Usage Enable Flag |
...
| ABSENCE_USAGE_CD | VARCHAR2 | 30 |  |  | Absence Usage Code |
| ABSENCE_FIELD_TYPE | VARCHAR2 | 30 |  |  | Absence Field Type |
| EMP_DEFAULT_CD | VARCHAR2 | 30 |  |  | Employee Default Code |
| MGR_DEFAULT_CD | VARCHAR2 | 30 |  |  | Manager Default Code |
| ADMIN_DEFAULT_CD | VARCHAR2 | 30 |  |  | Administrator Default Code |
| APPROVAL_DEFAULT_CD | VARCHAR2 | 30 |  |  | Approval Default Code |
...
| ENABLE_RULE_EDIT | VARCHAR2 | 30 |  |  | Absence Enable Rule Edit |
| RULE_REF_DATE_LOOKUP_TYPE | VARCHAR2 | 30 |  |  | Absence Rule Reference Date Lookup Type |
| PATTERN_USAGES_F_ALTCD | VARCHAR2 | 2000 |  |  | PATTERN_USAGES_F_ALTCD |
...
|---|---|---|---|
| ANC_ABS_PATTERN_USAGES_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ABS_PATTERN_USAGES_F_U1 | Unique | Default | ABSENCE_PATTERN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ABS_PATTERN_USAGES_F_U11 | Unique | Default | ABSENCE_PATTERN_USAGE_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
