...
Absence Entitlement Bands Base Table
...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsf-11007.html#ancentlbandsf-11007](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancentlbandsf-11007.html#ancentlbandsf-11007)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ENTL_BANDS_F_PK | ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ANC_ENTL_BANDS_F_ALTCD | VARCHAR2 | 240 |  | Yes | Absence Entitlement Bands Alternate Code |
| ENTERPRISE_ID | NUMBER |  | 18 | Yes | Enterprise |
| ENTL_BAND_SEQUENCE | NUMBER |  |  |  | Entitlement Band Sequence |
| ENTL_INPUT_EXPRESSION | CLOB |  |  |  | Entitlement Input Expression |
...
|---|---|---|---|
| ANC_ENTL_BANDS_F_N20 | Non Unique | Default | SGUID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
| ANC_ENTL_BANDS_F_PK | Unique | Default | ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET1 |
| ANC_ENTL_BANDS_F_PK1 | Unique | Default | ENTL_BAND_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, ORA_SEED_SET2 |
