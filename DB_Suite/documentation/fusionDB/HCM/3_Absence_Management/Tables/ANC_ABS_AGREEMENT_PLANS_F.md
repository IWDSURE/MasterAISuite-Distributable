...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsagreementplansf-7292.html#ancabsagreementplansf-7292](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/ancabsagreementplansf-7292.html#ancabsagreementplansf-7292)

## Primary Key

| Name | Columns |
|------|----------|
| ANC_ABS_AGREEMENT_PLANS_F_PK | ABS_AGREEMENT_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| ABS_AGREEMENT_PLANS_F_ALTCD | VARCHAR2 | 240 |  | Yes | ABS_AGREEMENT_PLANS_F_ALTCD |
...
|---|---|---|---|
| ANC_ABS_AGREEMENT_PLANS_F_PK | Unique | Default | ABS_AGREEMENT_PLAN_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
