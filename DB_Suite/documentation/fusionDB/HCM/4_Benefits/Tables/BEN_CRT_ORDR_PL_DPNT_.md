...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/bencrtordrpldpnt-6776.html#bencrtordrpldpnt-6776](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/bencrtordrpldpnt-6776.html#bencrtordrpldpnt-6776)

## Primary Key

| Name | Columns |
|------|----------|
| BEN_CRT_ORDR_PL_DPNT_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, CRT_ORDR_PL_DPNT_ID |
...
| CONTACT_PERSON_ID | NUMBER |  | 18 |  | Foreign key to PER_ALL_PEOPLE_F. |
| CRT_ORDR_ID | NUMBER |  | 18 |  | This column indicates Foreign key to BEN_CRT_ORDR_F. |
...
|---|---|---|---|
| BEN_CRT_ORDR_PL_DPNTN1_ | Non Unique | Default | CRT_ORDR_PL_DPNT_ID, LAST_UPDATE_DATE |
| BEN_CRT_ORDR_PL_DPNT_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, CRT_ORDR_PL_DPNT_ID |
