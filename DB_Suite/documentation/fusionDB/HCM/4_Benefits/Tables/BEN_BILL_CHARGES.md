...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benbillcharges-30095.html#benbillcharges-30095](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benbillcharges-30095.html#benbillcharges-30095)

## Primary Key

| Name | Columns |
|------|----------|
| BEN_BILL_CHARGES_PK | BILL_CHARGE_ID |
...
| BILLING_DATE | DATE |  |  | Yes | This column indicates the bill generation date. |
| HOLD_BILL_FLAG | VARCHAR2 | 30 |  | Yes | This column indicates that hold bill flag is set Y or N. |
...
| BILL_YEAR | VARCHAR2 | 30 |  | Yes | This column indicates the year of bill generation which flows from BEN_BILL_CALENDAR. |
| BILL_PERIOD | VARCHAR2 | 120 |  | Yes | This column indicates the billing period which flows from BEN_BILL_CALENDAR. |
| STATUS | VARCHAR2 | 30 |  | Yes | This column indicates the billing status for which the possible values are Open, Unpaid, Partially-paid, and Fully-paid. |
| BILL_CAL_ID | NUMBER |  | 18 | Yes | This column indicates the Foreign Key to BEN_BILL_CALENDAR. |
| BILL_SOURCE | VARCHAR2 | 30 |  | Yes | This column determines if bill was generated manually or by batch process. |
| COMMENTS | VARCHAR2 | 4000 |  |  | This column indicates the comments which flows from BEN_BILL_CALENDAR. |
| BILL_GENERATED | VARCHAR2 | 30 |  | Yes | This column indicates that the bill is generated or not. It holds Y or N as value. |
...
| BILL_NUM | NUMBER |  | 18 | Yes | This column indicates the Generated ID, could be PK as well. |
...
| PER_ACCT_NUM | NUMBER |  | 18 | Yes | This column indicates the Foreign Key to PER_ALL_PEOPLE_F. |
...
|---|---|---|---|
| BEN_BILL_CHARGES_FK1 | Non Unique | Default | PERSON_ID |
| BEN_BILL_CHARGES_FK2 | Non Unique | Default | BILL_CAL_ID |
| BEN_BILL_CHARGES_FK3 | Non Unique | Default | PER_ACCT_NUM |
| BEN_BILL_CHARGES_PK1 | Unique | Default | BILL_CHARGE_ID |
