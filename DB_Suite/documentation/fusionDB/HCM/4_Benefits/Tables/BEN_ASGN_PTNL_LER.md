...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benasgnptnller-3797.html#benasgnptnller-3797](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benasgnptnller-3797.html#benasgnptnller-3797)

## Primary Key

| Name | Columns |
|------|----------|
| BEN_ASGN_PTNL_LER_PK | ASGN_PTNL_LER_ID |
...
| OCCURRED_DATE | DATE |  |  | Yes | This column holds life event occurred date as given by the employee. |
| BENEFIT_RELATION_ID | NUMBER |  | 18 | Yes | This column holds foreign key to BEN_BENEFIT_RELATIONS_F. |
| SUBMITTED_DATE | DATE |  |  | Yes | This column holds the date when the self-assigned life event was submitted. |
| STATUS_CD | VARCHAR2 | 30 |  | Yes | This column holds life event status. |
...
|---|---|---|---|
| BEN_ASGN_PTNL_LER_N1 | Non Unique | Default | PERSON_ID, STATUS_CD |
| BEN_ASGN_PTNL_LER_N2 | Non Unique | Default | BENEFIT_RELATION_ID, STATUS_CD |
| BEN_ASGN_PTNL_LER_N3 | Non Unique | Default | LER_ID |
| BEN_ASGN_PTNL_LER_N4 | Non Unique | Default | DOR_ID |
| BEN_ASGN_PTNL_LER_N5 | Non Unique | Default | PTNL_LER_FOR_PER_ID |
| BEN_ASGN_PTNL_LER_N6 | Non Unique | Default | OCCURRED_DATE, STATUS_CD |
| BEN_ASGN_PTNL_LER_PK | Unique | Default | ASGN_PTNL_LER_ID |
