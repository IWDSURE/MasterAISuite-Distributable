...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benperbillinfof-19329.html#benperbillinfof-19329](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/benperbillinfof-19329.html#benperbillinfof-19329)

## Primary Key

| Name | Columns |
|------|----------|
| BEN_PER_BILL_INFO_F_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, PER_BILL_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| PER_ACCT_NUM | NUMBER |  | 18 |  | Foreign Key to PER_ALL_PEOPLE_F. |
| EFFECTIVE_START_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the beginning of the date range within which the row is effective. |
| EFFECTIVE_END_DATE | DATE |  |  | Yes | Date Effective Entity: indicates the date at the end of the date range within which the row is effective. |
| STOP_BILL_FLAG | VARCHAR2 | 30 |  |  | This column indicates the stop billing is set to Y or N. |
...
|---|---|---|---|
| BEN_PER_BILL_INFO_FN1_ | Non Unique | Default | PER_BILL_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE, LAST_UPDATE_DATE |
| BEN_PER_BILL_INFO_PK1_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, PER_BILL_INFO_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
