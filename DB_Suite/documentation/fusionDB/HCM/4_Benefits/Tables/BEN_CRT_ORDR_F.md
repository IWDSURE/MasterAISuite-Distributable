...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/bencrtordrf-16016.html#bencrtordrf-16016](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/bencrtordrf-16016.html#bencrtordrf-16016)

## Primary Key

| Name | Columns |
|------|----------|
| BEN_CRT_ORDR_F_PK | CRT_ORDR_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
...
| CRT_ORDR_TYP_CD | VARCHAR2 | 30 |  | Yes | This column indicates Court order type. |
| CRT_ORDR_STAT_CD | VARCHAR2 | 30 |  | Yes | Court order status to determine if it is to be enforced or not. |
| BUSINESS_GROUP_ID | NUMBER |  | 18 | Yes | Foreign key to HR_ORGANIZATION_UNITS. |
| ORDR_END_DATE | DATE |  |  |  | This column indicates Court Order ending date. |
| ORDR_START_DATE | DATE |  |  | Yes | This column indicates  Court order starting date. |
...
|---|---|---|---|
| BEN_CRT_ORDR_F_N1 | Non Unique | Default | PERSON_ID, CRT_ORDR_TYP_CD, CRT_ORDR_STAT_CD |
| BEN_CRT_ORDR_F_PK | Unique | Default | CRT_ORDR_ID, EFFECTIVE_START_DATE, EFFECTIVE_END_DATE |
