...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffplangrids-9650.html#htsstaffplangrids-9650](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffplangrids-9650.html#htsstaffplangrids-9650)

## Primary Key

| Name | Columns |
|------|----------|
| HTS_STAFF_PLAN_GRIDS_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, STAFF_PLAN_GRID_ID |
...
| STAFF_PLAN_ID | NUMBER |  | 18 |  | Staffing Plan Id |
| STAFF_GRID_ID | NUMBER |  | 18 |  | Grid unique id |
| DESCRIPTIVE_FLEXFIELD_CODE | VARCHAR2 | 40 |  |  | Flex Filed Code used in Grid rable |
...
|---|---|---|---|
| HTS_STAFF_PLAN_GRIDS_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, STAFF_PLAN_GRID_ID |
