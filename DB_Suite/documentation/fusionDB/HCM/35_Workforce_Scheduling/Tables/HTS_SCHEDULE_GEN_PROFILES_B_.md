...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsschedulegenprofilesb-21922.html#htsschedulegenprofilesb-21922](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsschedulegenprofilesb-21922.html#htsschedulegenprofilesb-21922)

## Primary Key

| Name | Columns |
|------|----------|
| HTS_SCHEDULE_GEN_PROFILES_PK_ | LAST_UPDATE_DATE, LAST_UPDATED_BY, SCHED_GEN_PROFILE_ID |
...
| ENTERPRISE_ID | NUMBER |  | 18 |  | Standard Enterprise Identifier column for multi tenancy support | Active |
| SCHED_PROFILE_CODE | VARCHAR2 | 30 |  |  | Schedule Generation Profile Code |  |
| ACTIVE_START_DATE | DATE |  |  |  | Schedule Generation Profile Active Start Date |  |
...
|---|---|---|---|
| HTS_SCHEDULE_GEN_PROFILES_BN1_ | Non Unique | Default | SCHED_GEN_PROFILE_ID |
| HTS_SCHEDULE_GEN_PROFILES_PK_ | Unique | Default | LAST_UPDATE_DATE, LAST_UPDATED_BY, SCHED_GEN_PROFILE_ID |
