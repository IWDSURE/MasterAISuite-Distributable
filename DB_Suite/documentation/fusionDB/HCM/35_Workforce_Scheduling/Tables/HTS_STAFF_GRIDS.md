...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffgrids-22887.html#htsstaffgrids-22887](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffgrids-22887.html#htsstaffgrids-22887)

## Primary Key

| Name | Columns |
|------|----------|
| HTS_STAFF_GRIDS_PK | STAFF_GRID_ID |
...
| GRID_CODE | VARCHAR2 | 280 |  | Yes | Grid Code or Template Name |
...
|---|---|---|---|
| HTS_STAFF_GRIDS_PK | Unique | Default | STAFF_GRID_ID |
| HTS_STAFF_GRIDS_U1 | Unique | Default | UPPER("GRID_CODE") |
