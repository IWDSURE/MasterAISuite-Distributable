...
**Source:** [https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffgridvalues-16682.html#htsstaffgridvalues-16682](https://docs.oracle.com/en/cloud/saas/human-resources/oedmh/htsstaffgridvalues-16682.html#htsstaffgridvalues-16682)

## Primary Key

| Name | Columns |
|------|----------|
| HTS_STAFF_GRID_VALUES_PK | GRID_VALUE_ID |
...
| STAFF_GRID_ID | NUMBER |  | 18 | Yes | Unique Id of Parent table |
| SKILL_ID | NUMBER |  | 18 |  | Skill ID |
| SHIFT_TYPE_ID | NUMBER |  | 18 | Yes | Shift Type |
| START_TIME_OFFSET | NUMBER |  | 9 | Yes | Start Time offset |
| STOP_TIME_OFFSET | NUMBER |  | 9 | Yes | End Time Offset |
| STAFF_PLAN_SKILL_ID | NUMBER |  | 18 | Yes | Plan Job or filtered skill ID without qualification |
...
|---|---|---|---|
| HTS_STAFF_GRID_VALUES_N1 | Non Unique | Default | STAFF_GRID_ID |
| HTS_STAFF_GRID_VALUES_PK | Unique | Default | GRID_VALUE_ID |
